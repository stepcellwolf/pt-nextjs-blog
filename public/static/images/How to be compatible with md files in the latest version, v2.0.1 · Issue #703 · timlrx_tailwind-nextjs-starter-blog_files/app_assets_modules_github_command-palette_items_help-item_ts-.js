...
;(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
  ...
  ],
  {
    94831: (e, t, r) => {
      ...
      var o = r(76006),
        ...
        s = function (e, t, r, o) {
          var i,
            s = arguments.length,
            n = s < 3 ? t : null === o ? (o = Object.getOwnPropertyDescriptor(t, r)) : o
          if ('object' == typeof Reflect && 'function' == typeof Reflect.decorate)
            n = Reflect.decorate(e, t, r, o)
          else
            for (var a = e.length - 1; a >= 0; a--)
              (i = e[a]) && (n = (s < 3 ? i(n) : s > 3 ? i(t, r, n) : i(t, r)) || n)
          return s > 3 && n && Object.defineProperty(t, r, n), n
        }
      let n = class ClientDefinedProviderElement extends i.b {
        static build(e, t) {
          let r = new ClientDefinedProviderElement()
          return (r.providerId = e), (r.provider = t), r
        }
        connectedCallback() {
          this.setAttribute('data-targets', 'command-palette.clientDefinedProviderElements')
        }
      }
      s([o.Lj], n.prototype, 'providerId', void 0), (n = s([o.Ih], n))
    },
    7667: (e, t, r) => {
      r.d(t, { Z: () => g, o: () => y })
      var o,
      ...
      let h = () => navigator.platform.match(/Mac/),
        m = h() ? 'metaKey' : 'ctrlKey',
        f = h() ? 'Meta' : 'Control',
        y = (e) => e instanceof KeyboardEvent && e[m],
        g =
          (((o = class CommandPalette extends HTMLElement {
            setup() {
              ;(this.modes = Array.from(this.querySelectorAll('command-palette-mode'))),
                (this.defaultMode = this.querySelector('.js-command-palette-default-mode')),
                (this.commandPaletteInput = this.querySelector('command-palette-input')),
                (this.groups = this.querySelectorAll('command-palette-item-group')),
                this.defaultOpen && (this.manualToggle(!0), this.clearReturnToParams()),
                (window.commandPalette = this),
                (this.setupComplete = !0)
              let e = new Event('command-palette-ready', { bubbles: !0, cancelable: !0 })
            ...
            clear(e = !0) {
              this.clearProviderCaches(), this.pageStack.reset(), e && this.resetInput()
            }
            clearCommands(e = !0) {
              return (
                this.everActivated && (this.clearCommandProviderCaches(), e && this.resetInput()),
                Promise.resolve()
              )
            }
            resetInput() {
            ...
            activate() {
              ;(this.sessionId = this.generateSessionId()),
                (this.commandPaletteInput.scopeElement.smallDisplay = this.offsetWidth < 450),
            ...
            deactivate() {
              ;(this.activated = !1),
                ...
                (0, d.j)('session_terminated')
            }
            generateSessionId() {
              return (0, c.k)(`${Date.now()}_${this.userId}_${this.query.path}`).toString()
            }
            manualToggle(e) {
            ...
            platformHotkey(e) {
              if ('none' === e) return ''
              let t = e
              if (h()) t = t.replace(/Mod\+Alt/g, 'Alt+Mod')
              else if (t.includes('Shift')) {
                let e = t.charAt(t.length - 1)
                t += `,${t.replace(`Shift+${e}`, e.toUpperCase())}`
              }
              return t.replace(/Mod/g, f)
            }
            onInput() {
              this.everActivated &&
            ...
            itemsUpdated(e) {
              ...
              let t = e.detail.items,
                r = t.filter((e) => e.group !== n.O.footerGroupId),
                o = r.filter((e) => !e.group || !n.O.helpGroupIds.includes(e.group)),
                i = r.length > o.length,
                s = 0 === o.length && this.activated
              o.length > 0
                ? this.toggleEmptyState(!1, i)
                : s && (this.toggleEmptyState(!0, i), this.toggleTips()),
                this.toggleErrorTips()
            }
            loadingStateChanged(e) {
              e instanceof CustomEvent && (this.commandPaletteInput.loading = e.detail.loading)
            }
            pageFetchError(e) {
              e instanceof CustomEvent && ((this.error = !0), this.toggleErrorTips())
            }
            selectedItemChanged(e) {
              if (!(e instanceof CustomEvent)) return
              let t = e.detail.item,
                r = e.detail.isDefaultSelection
              this.updateTypeahead(t, r)
            }
            ...
            setQuery() {
              ;(this.query = new l.A(this.getTextWithoutMode().trimStart(), this.getMode(), {
            ...
            onSelect(e) {
              this.selectedItem ? this.selectedItem.item.select(this) : e.preventDefault()
            }
            autocomplete(e) {
              ;(0, d.j)('autocompleted', e)
            ...
            setScope(e) {
              ...
              for (let e of t.tokens) {
                let r = e === t.tokens[t.tokens.length - 1],
                  o = new a.j({ title: e.value, scopeId: e.id, scopeType: e.type })
                this.pageStack.push(o, !r)
              }
              this.commandPaletteInput.inputValue = ''
            }
            onDescope() {
              this.toggleEmptyState(!1, !1), this.pageStack.pop(), this.toggleTips()
            }
            onInputClear() {
            ...
            close(e) {
              ...
              let t = document.querySelector('.command-palette-details-dialog')
              t.toggle(!1), e.stopImmediatePropagation(), e.preventDefault()
            }
            navigateToItem(e) {
            ...
            toggleTips() {
              ...
              ;(this.pageStack.hasVisibleTip = !!t), this.pageStack.currentPage.recomputeStyles()
            }
            toggleEmptyState(e, t) {
              for (let t of this.emptyStateElements) t.toggle(this.query, e)
              if (!t && e) {
                let e = this.serverDefinedProviderElements.find((e) => 'help' === e.type)
                e && this.pageStack.currentPage.fetch([e.provider], { isEmpty: !0 })
              }
            }
            toggleErrorTips() {
              for (let e of this.errorStateTips) e.toggle(this.query, !1, this.error)
            }
            inputReady(e) {
              e instanceof CustomEvent &&
                (this.resizeObserver ||
                  ((this.resizeObserver = new ResizeObserver((e) => {
                    for (let t of e)
                      this.commandPaletteInput.scopeElement.smallDisplay = t.contentRect.width < 450
                  })),
                  this.resizeObserver.observe(this)))
            }
            updateInputScope(e) {
              e instanceof CustomEvent &&
                ((this.commandPaletteInput.scope = this.pageStack.scope), this.setQuery())
            }
            updateTypeahead(e, t = !1) {
              '' === this.getTextWithoutMode() && (!e || t)
                ? (this.commandPaletteInput.typeahead = '')
                : e && (this.commandPaletteInput.typeahead = e.typeahead ?? e.title ?? '')
            }
            isCopyEvent(e) {
              return (
                !this.commandPaletteInput.textSelected() &&
                (h() ? e.metaKey && 'c' === e.key : e.ctrlKey && 'c' === e.key)
              )
            }
            setQueryScope() {
            ...
            clearCommandProviderCaches() {
              for (let e of this.commandsProviderElements) e.provider?.clearCache()
            }
            registerProvider(e, t) {
              let r = this.querySelector(`client-defined-provider[data-provider-id="${e}"]`)
              r && r.remove()
              let o = s.i.build(e, t)
              this.appendChild(o)
            }
            pushPage(e, t = !1) {
              t && this.pageStack.clear(!1), this.pageStack.push(e), this.resetInput()
            }
            get tipElements() {
              let e = this.querySelectorAll('command-palette-tip')
              return Array.from(e)
            }
            get modeTips() {
            ...
            clearReturnToParams() {
              ...
              e.delete('command_palette_open'),
                ...
                history.replaceState(null, '', `?${e}${location.hash}`)
            }
            displayFlash(e, t, r = 5e3) {
              let o = document.querySelector('.js-command-palette-toasts')
              if (!o) return
              let i = o.querySelectorAll('.Toast')
              for (let e of i) e.hidden = !0
              let s = o.querySelector(`.Toast.Toast--${e}`)
              if (!s) return
              let n = s.querySelector('.Toast-content')
              ;(n.textContent = t),
                (s.hidden = !1),
                setTimeout(() => {
                  s.hidden = !0
            ...
            constructor(...e) {
              super(...e),
                ...
                (this.userId = ''),
                (this.defaultOpen = !1),
                (this.activationHotkey = 'Mod+k,Mod+Alt+k'),
                (this.commandModeHotkey = 'Mod+Shift+k,Control+K')
            }
          }).tagName = 'command-palette'),
          (o.attrPrefix = ''),
          o)
      u([i.Lj], g.prototype, 'returnTo', void 0),
        u([i.Lj], g.prototype, 'userId', void 0),
        u([i.Lj], g.prototype, 'defaultOpen', void 0),
        u([i.Lj], g.prototype, 'activationHotkey', void 0),
        u([i.Lj], g.prototype, 'commandModeHotkey', void 0),
        u([i.fA], g.prototype, 'pageStack', void 0),
        u([i.GO], g.prototype, 'clientDefinedProviderElements', void 0),
        u([i.GO], g.prototype, 'serverDefinedProviderElements', void 0),
        u([(0, p.D)(250)], g.prototype, 'clearCommands', null),
        (g = u([i.Ih], g))
    },
    25543: (e, t, r) => {
      r.d(t, { O: () => a })
      ...
      let a =
        (((o = class CommandPaletteItemGroupElement extends HTMLElement {
          connectedCallback() {
          ...
          prepareForNewItems() {
            ;(this.list.textContent = ''),
              this.setAttribute('hidden', 'true'),
              this.classList.contains('border-top') || this.classList.add('border-top')
          }
          hasItem(e) {
            return this.list.querySelectorAll(`[data-item-id="${e.id}"]`).length > 0
          }
          renderElement(e) {
            ;(0, s.sY)(
              this.hasTitle
          ...
          push(e) {
            this.removeAttribute('hidden'),
              this.topGroup && this.atLimit
                ? e.itemId !== this.firstItem.itemId && this.replaceTopGroupItem(e)
                : this.list.append(e)
          }
        ...
        (o.activeModeLimit = 50),
        (o.topGroupId = 'top'),
        (o.defaultGroupId = 'default'),
        (o.footerGroupId = 'footer'),
        (o.helpGroupIds = ['modes_help', 'filters_help']),
        (o.commandGroupIds = ['commands']),
        (o.topGroupScoreThreshold = 9),
        o)
      n([i.Lj], a.prototype, 'groupTitle', void 0),
        n([i.Lj], a.prototype, 'groupHint', void 0),
        n([i.Lj], a.prototype, 'groupId', void 0),
        n([i.Lj], a.prototype, 'groupLimits', void 0),
        n([i.Lj], a.prototype, 'defaultPriority', void 0),
        n([i.Lj], a.prototype, 'skipTemplate', void 0),
        n([i.fA], a.prototype, 'list', void 0),
        n([i.fA], a.prototype, 'header', void 0),
        (a = n([i.Ih], a))
    },
    64316: (e, t, r) => {
      r.d(t, { v: () => a })
      ...
      let a =
        (((o = class CommandPaletteScopeElement extends HTMLElement {
          connectedCallback() {
          ...
          get scope() {
            return this.hasScope()
              ? { text: this.text, type: this.type, id: this.id, tokens: this.tokens }
          ...
          renderTokens(e) {
            ...
            let t = 0,
              r = e.length,
              o = this.smallDisplay ? 14 : 20,
              i = this.smallDisplay ? 20 : 55
            for (let s = e.length - 1; s >= 0 && !(t + Math.min(e[s].text.length, o) + 5 > i); s--)
              (t += Math.min(e[s].text.length, o) + 5), (r = s)
            let n = (e, t) => {
              let i = e.text.length > o ? `${e.text.substring(0, o - 3)}...` : e.text
              return (0, s.dy)`
      ...
      `
            ...
            ;(0, s.sY)((0, s.dy)`${e.map(n)}`, this),
              (this.hidden = !this.hasScope()),
              0 !== r && (this.placeholder.hidden = !1)
          }
          removeToken() {
            this.lastToken &&
          ...
          constructor(...e) {
            super(...e), (this.smallDisplay = !1)
          }
        }).emptyScope = { type: '', text: '', id: '', tokens: [] }),
        (o.observedAttributes = ['data-small-display']),
        o)
      n([i.Lj], a.prototype, 'smallDisplay', void 0),
        n([i.fA], a.prototype, 'placeholder', void 0),
        n([i.GO], a.prototype, 'tokens', void 0),
        (a = n([i.Ih], a))
    },
    98950: (e, t, r) => {
      function o(e) {
      ...
      function s(e) {
        ...
        let r = o(e)
        return t.appendChild(r), i(r), t.removeChild(r), Promise.resolve()
      }
      r.d(t, { z: () => s })
    },
    24728: (e, t, r) => {
      ...
      var o = r(7667),
        i = r(34106)
      let s = class AccessPolicyItem extends i.g {
        activate(e, t) {
          t instanceof PointerEvent
            ? super.activate(e, t)
            : t instanceof KeyboardEvent && this.activateLinkBehavior(e, t, (0, o.o)(t))
        }
        get key() {
          return this.title
        }
    ...
    776: (e, t, r) => {
      ...
      var o = r(34106),
        i = r(89445)
      let s = class CommandItem extends o.g {
        get action() {
          return this._action
        }
        async activate(e) {
          ...
          if (!t) return
          let r = e.query.params()
          r.set('command', this.action.id), (e.commandPaletteInput.loading = !0)
          let o = await (0, i.Q)(t, { method: 'POST', body: r })
          if (((e.commandPaletteInput.loading = !1), o.ok)) {
            let t = await o.json()
            this.handleResponse(e, t.action, t.arguments)
          } else e.displayFlash('error', 'Failed to run command')
        }
        handleResponse(e, t, r) {
          'displayFlash' === t && (e.displayFlash(r.type, r.message), e.dismiss())
        }
        constructor(e) {
    ...
    4328: (e, t, r) => {
      ...
      var o = r(34106),
        i = r(98950)
      let s = class CopyableItem extends o.g {
        get action() {
          return this._action
        }
        async activate(e) {
    ...
    79922: (e, t, r) => {
      r.d(t, { B: () => i })
      var o = r(34106)
      let i = class HelpItem extends o.g {
        static from(e) {
          return new HelpItem({
            title: e.title,
            typeahead: '',
        ...
        activate(e, t) {
          e.commandPaletteInput.inputValue = this.action.prefix + e.getTextWithoutMode()
        }
        autocomplete(e) {
          e.commandPaletteInput.inputValue = this.action.prefix + e.getTextWithoutMode()
        }
        ...
        constructor(e) {
          super(e), (this.persistentHint = e.persistentHint)
        }
      }
      i = (function (e, t, r, o) {
        var i,
    ...
    8407: (e, t, r) => {
      ...
      var o = r(7667),
        i = r(34106)
      let s = class JumpToItem extends i.g {
        static from(e) {
    ...
    73072: (e, t, r) => {
      ...
      var o = r(8407),
        i = r(34106)
      let s = class JumpToOrgItem extends o.s {}
      s = (function (e, t, r, o) {
        var i,
          s = arguments.length,
          n = s < 3 ? t : null === o ? (o = Object.getOwnPropertyDescriptor(t, r)) : o
    ...
    35446: (e, t, r) => {
      ...
      var o = r(8407),
        i = r(34106)
      let s = class JumpToTeamItem extends o.s {}
      s = (function (e, t, r, o) {
        var i,
          s = arguments.length,
          n = s < 3 ? t : null === o ? (o = Object.getOwnPropertyDescriptor(t, r)) : o
    ...
    63927: (e, t, r) => {
      r.d(t, { U: () => MainWindowCommandItem })
      var o = r(93345)
      let MainWindowCommandItem = class MainWindowCommandItem extends o.ck {
        get path() {}
        copy(e) {}
        activate(e) {
    ...
    95639: (e, t, r) => {
      ...
      let l =
        (((o = class SearchLinkItem extends n.s {
          static create(e) {
            let t, r, o
            let i = [...e.scope.tokens]
            for (; i.length > 0 && !this.searchableScopeTypes.includes(i[i.length - 1].type); )
              i.pop()
            if ((o = i.length > 0 ? i[i.length - 1] : void 0) && 'repository' === o.type) {
              let o = i.map((e) => e.text).join('/')
              ;(t = `in ${o}`), (r = `/${o}/search?q=${e.text}`)
            } else if (o && 'owner' === o.type) {
              let i = `org:${o.text} ${e.text}`
              ;(t = `in ${o.text}`), (r = `/search?q=${i}`)
            } else (t = 'across all of GitHub'), (r = `/search?q=${e.text}`)
            return new SearchLinkItem({
              title: `Search ${e.text}${t}`,
              typeahead: '',
              priority: -10,
              score: -10,
              group: s.O.footerGroupId,
              action: { type: 'jump_to', description: '', path: r },
          ...
          constructor(e) {
            super(e), (this.titleScope = e.titleScope)
          }
        }).searchableScopeTypes = ['owner', 'repository']),
        o)
      l = a([i.O], l)
    },
    34106: (e, t, r) => {
      r.d(t, { O: () => s, g: () => ServerDefinedItem })
      var o = r(93345),
        i = r(25543)
      function s(e) {
        ServerDefinedItem.register(e)
      }
      let ServerDefinedItem = class ServerDefinedItem extends o.ck {
        static register(e) {
        ...
        activate(e, t) {}
        activateLinkBehavior(e, t, r) {
          this.element?.activateLinkBehavior(e, t, r)
        }
        copy(e) {}
      ...
      ;(ServerDefinedItem.itemClasses = {}),
        (ServerDefinedItem.defaultData = {
          title: '',
          score: 1,
          priority: 1,
          action: { type: '', path: '' },
          icon: { type: 'octicon', id: 'dash-color-fg-muted' },
          group: i.O.defaultGroupId,
        })
    },
    48084: (e, t, r) => {
      r.d(t, { j: () => GlobalProvidersPage })
      let GlobalProvidersPage = class GlobalProvidersPage {
        get providers() {
          let e = []
          for (let t of this._providerElements) t.provider && e.push(t.provider)
          return e
        }
        ...
        get serverDefinedProviderElements() {
          let e = document.querySelectorAll('server-defined-provider')
          return Array.from(e)
        }
        get clientDefinedProviderElements() {
          let e = document.querySelectorAll('client-defined-provider')
          return Array.from(e)
        }
        constructor(e) {
          ;(this.title = e.title), (this.scopeId = e.scopeId), (this.scopeType = e.scopeType)
        }
      }
    },
    16852: (e, t, r) => {
      r.d(t, { b: () => ProviderElement })
    ...
    97165: (e, t, r) => {
      r.d(t, { B: () => ProviderBase })
      var o = r(93345)
      let ProviderBase = class ProviderBase extends o.BX {
        fuzzyFilter(e, t, r = 0) {
          if (t.isBlank()) return e
          let o = []
          for (let i of e) {
            let e = i.calculateScore(t.text)
            e > r && o.push(i)
          }
          return o
        }
    ...
    89803: (e, t, r) => {
      r.d(t, { j: () => ServerDefinedProvider })
      var o = r(97165)
      let ServerDefinedProvider = class ServerDefinedProvider extends o.B {
        get type() {
    ...
    50034: (e, t, r) => {
      ...
      let Query = class Query {
        ...
        clearScope() {
          this.scope = o.v.emptyScope
        }
        hasScope() {
          return this.scope.id !== o.v.emptyScope.id
        }
        isBlank() {
        ...
        constructor(e, t, { scope: r, subjectId: i, subjectType: s, returnTo: n } = {}) {
          ;(this.queryText = e),
            (this.queryMode = t),
            (this.scope = r ?? o.v.emptyScope),
            (this.subjectId = i),
            (this.subjectType = s),
            (this.returnTo = n)
        }
    ...
    52418: (e, t, r) => {
      ...
      function p(e, t) {
        let r
        let o = document.querySelector('command-palette'),
          i = ''
        t && ('commands' === t.group || 'global_commands' === t.group) && (i = t.title)
        let s = {
          command_palette_session_id: o.sessionId,
          command_palette_scope: o.query.scope.type,
          command_palette_mode: o.getMode(),
          command_palette_title: i,
          command_palette_position: t?.position,
          command_palette_score: t?.score,
          command_palette_group: t?.group,
          command_palette_item_type: t instanceof l.g ? t?.itemType : t?.constructor.name,
        }
        ;(r = 'activate' === e ? d(t) : e), (0, c.qP)(`command_palette_${r}`, s)
      }
      function d(e) {
    ...
    89359: (e, t, r) => {
      ...
      function i() {
        let e = o('meta[name=analytics-location]')
        return e ? e.content : window.location.pathname
      }
      function s() {
        let e = o('meta[name=analytics-location-query-strip]'),
          t = ''
        e || (t = window.location.search)
        let r = o('meta[name=analytics-location-params]')
      ...
      function n() {
        return `${window.location.protocol}//${window.location.host}${i() + s()}`
      }
      r.d(t, { S: () => n })
    },
    93345: (e, t, r) => {
      r.d(t, { BX: () => ProviderBase, Z4: () => StaticItemsPage, ck: () => Item })
      var o = r(47142),
        i = r(80425)
      let StaticItemsPage = class StaticItemsPage {
        constructor(e, t, r) {
          ;(this.providers = []),
            ...
            (this.title = e),
            (this.scopeId = t),
            (this.providers = [new StaticItemsProvider(r)])
        }
      }
      let StaticItemsProvider = class StaticItemsProvider {
        ...
        constructor(e) {
          ...
          let t = e.length
          this.items = e.map((e, r) => ((e.priority = t - r), e))
        }
      }
      let Item = class Item {
        get matchingFields() {
        ...
        get id() {
          return this._id || (this._id = (0, i.k)(this.key).toString()), this._id
        }
        calculateScore(e) {
          let t = this.matchingFields.map((t) =>
            this.calculateScoreForField({ field: t, queryText: e })
          )
          return Math.max(...t)
        }
        calculateScoreForField({ field: e, queryText: t }) {
          return (0, o.CD)(t, e) ? (0, o.Gs)(t, e) : -1 / 0
        }
        constructor(e) {
          ;(this.score = 0),
            (this.position = ''),
    ...
    24601: (e, t, r) => {
      ...
      function v(e, t = {}) {
        if ((0, p.c)('FAILBOT_HANDLE_NON_ERRORS')) {
          if (!f(e)) {
            if (x(e)) return
            let r = Error(),
              o = y(e),
      ...
      function S(e) {
        return { type: e.name, value: e.message, stacktrace: P(e) }
      }
      function T(e, t = {}) {
        return Object.assign(
          {
            error: e,
            sanitizedUrl: (0, n.S)() || window.location.href,
      ...
      let I = /(chrome|moz|safari)-extension:\/\//
      function E(e) {
        return e.some((e) => I.test(e.filename) || I.test(e.function))
      }
      function k() {
      ...
      let w = !1
      function _() {
        return !w && !d && u < 10 && (0, i.Gb)()
      }
      if (
        (c.iG?.addEventListener('pageshow', () => (w = !1)),
        c.iG?.addEventListener('pagehide', () => (w = !0)),
      ...
      function x(e) {
        ...
        if ('string' == typeof e) {
          if (C.some((t) => e.includes(t))) return !0
        } else if (
          'object' == typeof e &&
          'string' == typeof e.message &&
    ...
    95253: (e, t, r) => {
      let o
      r.d(t, { YT: () => u, qP: () => h, yM: () => m })
      var i = r(88149),
        s = r(86058),
        n = r(44544),
        a = r(71643)
      let { getItem: l } = (0, n.Z)('localStorage'),
        c = 'dimension_',
        p = ['utm_source', 'utm_medium', 'utm_campaign', 'utm_term', 'utm_content', 'scid']
      try {
        let e = (0, i.n)('octolytics')
        delete e.baseContext, (o = new s.R(e))
      } catch (e) {}
      function d(e) {
        let t = (0, i.n)('octolytics').baseContext || {}
        if (t)
        ...
        for (let [e, r] of o) p.includes(e.toLowerCase()) && (t[e] = r)
      ...
      function h(e, t = {}) {
        let r = document.head?.querySelector('meta[name="current-catalog-service"]')?.content,
          i = r ? { service: r } : {}
        for (let [e, r] of Object.entries(t)) null != r && (i[e] = `${r}`)
        o && (d(i), o.sendEvent(e || 'unknown', d(i)))
      }
      function m(e) {
    ...
    45974: (e, t, r) => {
      r.d(t, { dy: () => a.dy, sY: () => a.sY, Au: () => a.Au })
      var o = r(22490),
        i = r(7180)
      let s = 'jtml-no-op',
        n = o.ZO.createPolicy(s, {
          createHTML: (e) =>
            i.O.apply({ policy: () => e, policyName: s, fallback: e, fallbackOnError: !0 }),
        })
      var a = r(20845)
      a.js.setCSPTrustedTypesPolicy(n)
    },
    7180: (e, t, r) => {
      r.d(t, { O: () => p, d: () => TrustedTypesPolicyError })
      var o = r(46426),
        i = r(71643),
        s = r(24601),
        n = r(27856),
      ...
      function c({
        ...
        fallbackOnError: n = !1,
        sanitize: c,
        silenceErrorReporting: p = !1,
      }) {
        try {
          if ((0, o.c)('BYPASS_TRUSTED_TYPES_POLICY_RULES')) return r
          ;(0, i.b)(
          ...
          if (
            ...
            (p || (0, s.eK)(e),
            (0, i.b)({ incrementKey: 'TRUSTED_TYPES_POLICY_ERROR', trustedTypesPolicyName: t }),
            !n)
          )
            throw e
        }
    ...
    22490: (e, t, r) => {
      ...
      let n = {
        ...
        a = { createPolicy: (e, t) => ({ name: e, ...n, ...t }) },
        l = new Map(),
        c = globalThis.trustedTypes ?? a,
        p = {
          createPolicy: (e, t) => {
            if (l.has(e))
              return (0, i.b)({ incrementKey: 'TRUSTED_TYPES_POLICY_INITIALIZED_TWICE' }), l.get(e)
            {
        ...
        d = !1
      o.n4?.addEventListener('securitypolicyviolation', (e) => {
    ...
    89445: (e, t, r) => {
      function o(e, t = {}) {
        ...
        return fetch(e, { ...t, headers: r })
      }
      function i(e, t) {
        let r = t?.headers ?? {},
          i = { ...r, Accept: 'application/json', 'Content-Type': 'application/json' },
          s = t?.body ? JSON.stringify(t.body) : void 0
        return o(e, { ...t, body: s, headers: i })
      }
      r.d(t, { Q: () => o, v: () => i })
    },
  },
])
//# sourceMappingURL=app_assets_modules_github_command-palette_items_help-item_ts-app_assets_modules_github_comman-48ad9d-47558c940037.js.map
