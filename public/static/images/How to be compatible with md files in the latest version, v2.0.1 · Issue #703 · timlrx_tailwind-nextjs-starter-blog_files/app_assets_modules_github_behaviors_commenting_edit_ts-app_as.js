...
;(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
  ...
  ],
  {
    66602: (e, t, s) => {
      ...
      function y(e) {
        ...
        for (let e of t.querySelectorAll('input, textarea')) {
          ...
          ;(t.value = t.defaultValue),
            t.classList.contains('session-resumable-canceled') &&
              (t.classList.add('js-session-resumable'),
              t.classList.remove('session-resumable-canceled'))
        }
      ...
      ;(0, m.N7)('.js-comment-header-actions-deferred-include-fragment', {
        ...
        (0, n.on)('click', '.js-comment-edit-button', function (e) {
          ...
          let s = j(t)
          s ? s.addEventListener('include-fragment-replaced', () => f(t), { once: !0 }) : f(t)
        ...
        (0, n.on)('click', '.js-comment-cancel-button', y),
        (0, n.on)('click', '.js-cancel-issue-edit', function (e) {
        ...
        (0, c.AC)('.js-comment .js-comment-update', async function (e, t) {
            ...
            if (422 === e.response.status) {
              ...
              if (t.errors) {
                o instanceof HTMLElement &&
                  ((o.textContent = `There was an error posting your comment: ${t.errors.join(
                    ', '
                  )}`),
                  (o.hidden = !1))
                return
          ...
          let c = n.querySelector('.js-comment-body'),
            u =
              null != c &&
              'async' === e.getAttribute('data-submitting-tracking-block-update') &&
              (0, a.M)(c, !0, !0)
          if (
            (c && m.body && !u && (0, i.jI)(c, m.body, { keepInputValues: !0 }), null != m.source)
          ) {
            let e = n.querySelector('.js-comment-field')
            if (
              (e && ((e.defaultValue = m.source), u || (e.value = m.source)),
              ...
              if (document.querySelector('.js-merge-pr.is-merging')) {
                ...
                e instanceof HTMLTextAreaElement &&
                  ...
                  (e.value = e.defaultValue = m.default_merge_commit_message)
              }
              if (
                m.default_squash_commit_message &&
                document.querySelector('.js-merge-pr.is-squashing')
              ) {
                let e = document.querySelector('.js-merge-pull-request textarea')
                e instanceof HTMLTextAreaElement &&
                  e.value === e.defaultValue &&
                  (e.value = e.defaultValue = m.default_squash_commit_message)
              }
            }
            document
              .querySelector('.js-merge-box-button-merge')
              ?.setAttribute('data-input-message-value', m.default_merge_commit_message),
              document
                .querySelector('.js-merge-box-button-squash')
                ?.setAttribute('data-input-message-value', m.default_squash_commit_message)
          }
          ...
          n.classList.remove('is-comment-stale'),
            e.hasAttribute('data-submitting-tracking-block-update') ||
              n.classList.remove('is-comment-editing')
        ...
        (0, c.AC)(
          ...
          async function (e, t) {
            ...
            try {
              ...
              e.dispatchEvent(
                new CustomEvent('submit:complete', { bubbles: !0, detail: { error: s } })
              )
            }
        ...
        (0, c.AC)(
          '.js-timeline-comment-unminimize, .js-timeline-comment-minimize',
          async function (e, t) {
        ...
        (0, c.AC)(
          '.js-discussion-comment-unminimize, .js-discussion-comment-minimize',
          async function (e, t) {
            ...
            try {
              ...
              if (e.response.status >= 400 && e.response.status < 500) {
                if (e.response.html) {
                  let t = e.response.html
                    .querySelector('.js-discussion-comment')
        ...
        (0, c.AC)('.js-comment-delete', async function (e, t) {
          ...
          !s &&
            (s = e.closest('.js-comment-container') || e.closest('.js-line-comments')) &&
            1 !== s.querySelectorAll('.js-comment').length &&
            (s = e.closest('.js-comment'))
        ...
        (0, c.AC)('.js-issue-update', async function (e, t) {
          ...
          try {
            ...
            ;(i.textContent =
              e.response?.json?.errors?.[0] || 'Something went wrong. Please try again.'),
              (i.hidden = !1)
          }
          if (!s) return
            ...
            if (e) {
              if (e.querySelector('.js-merge-pr.is-merging')) {
                ...
                t instanceof HTMLInputElement &&
                  t.value === t.defaultValue &&
                  (t.value = t.defaultValue = o.default_merge_commit_title)
          ...
          for (let t of ((document.title = o.page_title), e.elements))
    ...
    81775: (e, t, s) => {
      ...
      let l = new WeakMap()
      function a(e) {
        l.get(e) || (e.addEventListener('change', () => m(e)), l.set(e, !0))
      }
      function m(e) {
        let t = e.checkValidity()
      ...
      ;(0, i.N7)('button[data-disable-invalid]', {
        ...
        initialize(e) {
          let t = e.form
          t && (a(t), (e.disabled = !t.checkValidity()))
        },
      }),
            ...
            if (s && 'radio' === e.type && n && t)
              for (let s of n.elements.namedItem(e.name))
                s instanceof HTMLInputElement &&
                  s.setCustomValidity(e.value === t ? 'unchanged' : '')
            else e.setCustomValidity(e.value === (t || e.defaultValue) ? 'unchanged' : '')
          }
          e.addEventListener('input', s), e.addEventListener('change', s), s(), e.form && m(e.form)
        }),
...
//# sourceMappingURL=app_assets_modules_github_behaviors_commenting_edit_ts-app_assets_modules_github_behaviors_ht-83c235-86adeb5ebc28.js.map
