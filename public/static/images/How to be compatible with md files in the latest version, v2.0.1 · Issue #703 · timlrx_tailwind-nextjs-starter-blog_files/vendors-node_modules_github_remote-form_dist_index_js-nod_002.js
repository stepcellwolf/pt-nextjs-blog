...
;(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
  [
    ...
    'vendors-node_modules_github_remote-form_dist_index_js-node_modules_delegated-events_dist_inde-c537340',
    'vendors-node_modules_delegated-events_dist_index_js-node_modules_github_catalyst_lib_index_js-b4a243',
  ...
  ],
  {
    65935: (e, t, n) => {
      ...
      function i(e) {
        ...
        for (let [e, o] of [...n]) t.append(e, o.toString())
        return t.toString()
      }
      n.d(t, { AC: () => u, rK: () => d, uT: () => c })
      ...
      function s() {
        let e, t
        let n = new Promise(function (n, o) {
          ;(e = n), (t = o)
        })
        return [n, e, t]
      }
      ...
      async function g(e) {
        let t = await window.fetch(e.url, {
          ...
          n = {
            ...
            get html() {
              let e = this
              return delete e.html, (e.html = r(document, e.text)), e.html
            },
          },
          o = await t.text()
        if (((n.text = o), t.ok)) return n
    ...
    59753: (e, t, n) => {
      ...
      function f(e, t) {
        var n, o, r
        for (n = 0, o = e.length; n < o; n++) if (((r = e[n]), t.isPrototypeOf(r))) return r
      }
      function h(e, t) {
        return e.id - t.id
      }
      ;(o.prototype.logDefaultIndexUsed = function () {}),
        (o.prototype.add = function (e, t) {
          ...
          if ('string' == typeof e) {
            for (
              ...
              (s = (d = c[o]).key),
                (a = f(h, (i = d.index))) || (((a = Object.create(i)).map = new r()), h.push(a)),
                i === this.indexes.default && this.logDefaultIndexUsed(n),
                (l = a.map.get(s)) || ((l = []), a.map.set(s, l)),
                l.push(n)
            this.size++, p.push(e)
          }
        }),
          ...
          if ('string' == typeof e) {
            ...
            for (r = 0, n = u(this.indexes, e); r < n.length; r++)
              for (o = n[r], i = d.length; i--; )
                if (((a = d[i]), o.index.isPrototypeOf(a))) {
                  if ((l = a.map.get(o.key)))
                    for (s = l.length; s--; )
                      (c = l[s]).selector === e &&
                        (m || c.data === t) &&
        ...
        (o.prototype.queryAll = function (e) {
          ...
          for (t = 0, o = u.length; t < o; t++)
            for (n = 0, i = u[t], r = (s = this.matches(i)).length; n < r; n++)
              c[(l = s[n]).id]
                ? (a = c[l.id])
      ...
      function j(e) {
        if (k(e)) {
          ...
          if (t) {
            var n = _(t, e.target, 1 === e.eventPhase)
            if (n.length) {
              v(e, 'stopPropagation', x), v(e, 'stopImmediatePropagation', A), S(e, E)
              for (var o = 0, r = n.length; o < r && !g.get(e); o++) {
                var i = n[o]
                y.set(e, i.node)
                for (var s = 0, a = i.observers.length; s < a && !b.get(e); s++)
      ...
      function C(e, t, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
          ...
          s = i ? m : p,
          a = s[e]
        a || ((a = new o()), (s[e] = a), document.addEventListener(e, j, i)), a.add(t, n)
      }
      function O(e, t, n) {
        var o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
          ...
          i = r ? m : p,
          s = i[e]
        s && (s.remove(t, n), s.size || (delete i[e], document.removeEventListener(e, j, r)))
      }
      function P(e, t, n) {
    ...
    76006: (e, t, n) => {
      let o
      n.d(t, { Lj: () => v, Ih: () => C, P4: () => h, nW: () => F, fA: () => k, GO: () => j })
      let r = new WeakSet()
      function i(e) {
        r.add(e), e.shadowRoot && s(e.shadowRoot), c(e), l(e.ownerDocument)
      }
      function s(e) {
        c(e), l(e)
      }
      ...
      function p(e, t) {
        let n = e.tagName.toLowerCase(),
          o = []
        if (e.shadowRoot)
          for (let r of e.shadowRoot.querySelectorAll(`[data-targets~="${n}.${t}"]`))
            r.closest(n) || o.push(r)
        for (let r of e.querySelectorAll(`[data-targets~="${n}.${t}"]`))
          r.closest(n) === e && o.push(r)
        return o
      }
      let m = (e) =>
      ...
      function A(e) {
        ...
        Object.defineProperty(e, 'observedAttributes', {
          configurable: !0,
          get: () => [...S(e.prototype, w)].map(o).concat(t),
          set(e) {
            t = e
          },
        })
      ...
      let CatalystDelegate = class CatalystDelegate {
        ...
        connectedCallback(e, t) {
          e.toggleAttribute('data-catalyst', !0),
            ...
            i(e),
            t?.call(e),
            e.shadowRoot && s(e.shadowRoot)
        }
        disconnectedCallback(e, t) {
          t?.call(e)
        }
        attributeChangedCallback(e, t, n, o, r) {
          x(e), 'data-catalyst' !== t && r && r.call(e, t, n, o)
        }
      }
      function S(e, t) {
        if (!Object.prototype.hasOwnProperty.call(e, E)) {
          let t = e[E],
            n = (e[E] = new Map())
          if (t) for (let [e, o] of t) n.set(e, new Set(o))
        }
        let n = e[E]
      ...
      let O = new Map(),
        ...
        M = { ready: () => P, firstInteraction: () => $, visible: L },
        I = new WeakMap()
      function q(e) {
        cancelAnimationFrame(I.get(e) || 0),
          I.set(
            e,
              ...
              for (let t of O.keys()) {
                ...
                if (customElements.get(t) || n) {
                  let o = n?.getAttribute('data-load-on') || 'ready',
                    r = o in M ? M[o] : M.ready
                  for (let e of O.get(t) || []) r(t).then(e)
                  O.delete(t), I.delete(e)
                }
              }
            })
          )
        ...
        O.has(e) || O.set(e, new Set()),
          ...
          o ||
            (o = new MutationObserver((e) => {
              if (O.size) for (let t of e) for (let e of t.addedNodes) e instanceof Element && q(e)
