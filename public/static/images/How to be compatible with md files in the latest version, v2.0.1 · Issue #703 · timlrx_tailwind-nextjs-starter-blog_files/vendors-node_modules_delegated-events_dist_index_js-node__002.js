...
;(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
  ['vendors-node_modules_delegated-events_dist_index_js-node_modules_github_catalyst_lib_index_js'],
  {
    59753: (e, t, n) => {
      ...
      ;(o.prototype.logDefaultIndexUsed = function () {}),
        (o.prototype.add = function (e, t) {
          ...
          if ('string' == typeof e) {
            for (
              ...
              (i = (d = c[o]).key),
                (s = f(h, (a = d.index))) || (((s = Object.create(a)).map = new r()), h.push(s)),
                a === this.indexes.default && this.logDefaultIndexUsed(n),
                (l = s.map.get(i)) || ((l = []), s.map.set(i, l)),
                l.push(n)
            this.size++, p.push(e)
          }
        }),
        ...
        (o.prototype.queryAll = function (e) {
          ...
          for (t = 0, o = u.length; t < o; t++)
            for (n = 0, a = u[t], r = (i = this.matches(a)).length; n < r; n++)
              c[(l = i[n]).id]
                ? (s = c[l.id])
                : ((s = { id: l.id, selector: l.selector, data: l.data, elements: [] }),
                  (c[l.id] = s),
                  d.push(s)),
                s.elements.push(a)
          return d.sort(h)
      ...
      function O(e) {
        if (C(e)) {
          ...
          if (t) {
            ...
            if (n.length) {
              w(e, 'stopPropagation', x), w(e, 'stopImmediatePropagation', k), E(e, S)
              for (var o = 0, r = n.length; o < r && !b.get(e); o++) {
                var a = n[o]
                y.set(e, a.node)
                for (var i = 0, s = a.observers.length; i < s && !m.get(e); i++)
      ...
      function P(e, t, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
          ...
          i = a ? g : p,
          s = i[e]
        s || ((s = new o()), (i[e] = s), document.addEventListener(e, O, a)), s.add(t, n)
      }
      function j(e, t, n) {
        var o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
          ...
          a = r ? g : p,
          i = a[e]
        i && (i.remove(t, n), i.size || (delete a[e], document.removeEventListener(e, O, r)))
      }
      function M(e, t, n) {
    ...
    76006: (e, t, n) => {
      let o
      n.d(t, { Lj: () => w, Ih: () => P, P4: () => h, nW: () => N, fA: () => C, GO: () => O })
      let r = new WeakSet()
      function a(e) {
      ...
      function x(e, t) {
        ...
        for (let r of (t || (t = E(n, v)), t)) {
          ...
          'number' == typeof t
            ...
            r in e && !e.hasAttribute(n) && a.set.call(e, t)
        }
      }
      function k(e) {
        ...
        Object.defineProperty(e, 'observedAttributes', {
          configurable: !0,
          get: () => [...E(e.prototype, v)].map(o).concat(t),
          set(e) {
            t = e
          },
        })
      ...
      let j = new Map(),
        ...
        F = { ready: () => M, firstInteraction: () => $, visible: L },
        I = new WeakMap()
      function q(e) {
              ...
              for (let t of j.keys()) {
                ...
                if (customElements.get(t) || n) {
                  let o = n?.getAttribute('data-load-on') || 'ready',
                    r = o in F ? F[o] : F.ready
                  for (let e of j.get(t) || []) r(t).then(e)
                  j.delete(t), I.delete(e)
                }
              }
            })
          )
      ...
      function N(e, t) {
        j.has(e) || j.set(e, new Set()),
          j.get(e).add(t),
          q(document.body),
          o ||
            (o = new MutationObserver((e) => {
              if (j.size) for (let t of e) for (let e of t.addedNodes) e instanceof Element && q(e)
            })).observe(document, { subtree: !0, childList: !0 })
      }
    },
  },
])
//# sourceMappingURL=vendors-node_modules_delegated-events_dist_index_js-node_modules_github_catalyst_lib_index_js-1755a122eb9c.js.map
