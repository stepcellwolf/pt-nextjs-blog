...
;(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
  ['code-menu'],
  {
    ...
    41246: (e, t, o) => {
      ...
      let { getItem: l, setItem: c } = (0, a.Z)('localStorage'),
    ...
    4412: (e, t, o) => {
      ...
      var n = o(86283)
      let r =
          n.n4?.readyState === 'interactive' || n.n4?.readyState === 'complete'
            ? Promise.resolve()
            : new Promise((e) => {
    ...
    44544: (e, t, o) => {
      ...
      function i(e, t = { throwQuotaErrorsOnSet: !1 }, o = n.iG, i = (e) => e, s = (e) => e) {
        let l
        try {
          if (!o) throw Error()
          l = o[e] || new a()
        ...
        let { throwQuotaErrorsOnSet: c } = t
        function d(e) {
          t.sendCacheStats && (0, r.b)({ incrementKey: e })
        }
        function u(e) {
          try {
      ...
      function s(e) {
        return i(e, { throwQuotaErrorsOnSet: !1 }, window, JSON.parse, JSON.stringify)
      }
    },
    86283: (e, t, o) => {
      o.d(t, {
      ...
      let n = 'undefined' == typeof document ? void 0 : document,
        ...
        i =
          'undefined' == typeof location
            ? { pathname: '', origin: '', search: '', hash: '' }
            : location
    },
    35647: (e, t, o) => {
      o.d(t, { Qg: () => a, W6: () => r, cF: () => i })
      var n = o(73614)
      let r = void 0 === n.n4,
        a = !r
      function i() {
        return !!r || Boolean(n.n4.querySelector('react-app[data-ssr="true"]'))
      }
    },
    71643: (e, t, o) => {
      o.d(t, { B: () => g, b: () => l })
      ...
      function u() {
        ...
        if (!e) return
        let t = f(s)
        for (let o of t) p(e, `{"stats": [${o.join(',')}] }`)
        s = []
      }
      function f(e) {
        let t = [],
          o = e.map((e) => JSON.stringify(e))
        for (; o.length > 0; ) t.push(h(o))
        return t
      }
      function h(e) {
        let t = e.shift(),
      ...
      function m() {
        return !!n.n4?.head?.querySelector('meta[name="user-login"]')?.content
      }
      function g() {
    ...
    76006: (e, t, o) => {
      let n
      o.d(t, { Lj: () => v, Ih: () => P, P4: () => h, nW: () => x, fA: () => O, GO: () => k })
      let r = new WeakSet()
      function a(e) {
        r.add(e), e.shadowRoot && i(e.shadowRoot), c(e), l(e.ownerDocument)
      }
      function i(e) {
        c(e), l(e)
      }
      ...
      function l(e = document) {
        ...
        o.observe(e, { childList: !0, subtree: !0, attributeFilter: ['data-action'] })
        let n = {
          get closed() {
            return t
          },
          unsubscribe() {
            ;(t = !0), s.delete(e), o.disconnect()
          },
        }
        return s.set(e, n), n
      }
      ...
      function f(e) {
        for (let t of u(e)) e.addEventListener(t.type, d)
      }
      function h(e, t) {
      ...
      function p(e, t) {
        let o = e.tagName.toLowerCase(),
          n = []
        if (e.shadowRoot)
          for (let r of e.shadowRoot.querySelectorAll(`[data-targets~="${o}.${t}"]`))
            r.closest(o) || n.push(r)
        for (let r of e.querySelectorAll(`[data-targets~="${o}.${t}"]`))
          r.closest(o) === e && n.push(r)
        return n
      }
      let m = (e) =>
      ...
      function b(e) {
        let t = m(e.name).replace(/-element$/, '')
        try {
      ...
      function S(e, t) {
        ...
        for (let r of (t || (t = L(o, w)), t)) {
          ...
          'number' == typeof t
            ...
            r in e && !e.hasAttribute(o) && a.set.call(e, t)
        }
      }
      function C(e) {
        ...
        Object.defineProperty(e, 'observedAttributes', {
          configurable: !0,
          get: () => [...L(e.prototype, w)].map(n).concat(t),
          set(e) {
            t = e
          },
        })
      }
      let E = Symbol.for('catalyst')
      let CatalystDelegate = class CatalystDelegate {
        ...
        connectedCallback(e, t) {
          e.toggleAttribute('data-catalyst', !0),
            ...
            a(e),
            t?.call(e),
            e.shadowRoot && i(e.shadowRoot)
        }
        disconnectedCallback(e, t) {
          t?.call(e)
        }
        attributeChangedCallback(e, t, o, n, r) {
          S(e), 'data-catalyst' !== t && r && r.call(e, t, o, n)
        }
      }
      function L(e, t) {
        if (!Object.prototype.hasOwnProperty.call(e, E)) {
          let t = e[E],
            o = (e[E] = new Map())
          if (t) for (let [e, n] of t) o.set(e, new Set(n))
        }
        let o = e[E]
      ...
      let T = new Map(),
        ...
        D = new Promise((e) => {
          ...
          let o = { once: !0, passive: !0, signal: t.signal },
            n = () => t.abort()
          document.addEventListener('mousedown', n, o),
            document.addEventListener('touchstart', n, o),
            document.addEventListener('keydown', n, o),
            document.addEventListener('pointerdown', n, o)
        }),
        $ = (e) =>
          new Promise((t) => {
        ...
        M = { ready: () => I, firstInteraction: () => D, visible: $ },
        R = new WeakMap()
      function q(e) {
        cancelAnimationFrame(R.get(e) || 0),
          R.set(
            e,
              ...
              for (let t of T.keys()) {
                ...
                if (customElements.get(t) || o) {
                  let n = o?.getAttribute('data-load-on') || 'ready',
                    r = n in M ? M[n] : M.ready
                  for (let e of T.get(t) || []) r(t).then(e)
                  T.delete(t), R.delete(e)
                }
              }
            })
          )
        ...
        T.has(e) || T.set(e, new Set()),
          ...
          n ||
            (n = new MutationObserver((e) => {
              if (T.size) for (let t of e) for (let e of t.addedNodes) e instanceof Element && q(e)
    ...
    15205: (e, t, o) => {
      ...
      function r(e, t = {}) {
        let { hash: o = n, cache: r = new Map() } = t
        return function (...t) {
  ...
  (e) => {
    var t = (t) => e((e.s = t))
    e.O(0, ['vendors-node_modules_github_selector-observer_dist_index_esm_js'], () => t(4722))
    var o = e.O()
  },
])
//# sourceMappingURL=code-menu-2f78e6666020.js.map
