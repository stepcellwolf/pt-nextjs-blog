    ...
    48873: (e, t, o) => {
      var i,
        ...
        n = function (e, t, o, i) {
          var s,
            l = arguments.length,
            a = l < 3 ? t : null === i ? (i = Object.getOwnPropertyDescriptor(t, o)) : i
          if ('object' == typeof Reflect && 'function' == typeof Reflect.decorate)
            a = Reflect.decorate(e, t, o, i)
          else
            for (var n = e.length - 1; n >= 0; n--)
              (s = e[n]) && (a = (l < 3 ? s(a) : l > 3 ? s(t, o, a) : s(t, o)) || a)
          return l > 3 && a && Object.defineProperty(t, o, a), a
        }
      let r = class NotificationsListSubscriptionFormElement extends HTMLElement {
        connectedCallback() {
          ...
          e?.addEventListener('loadend', () => {
            this.subscriptionsLabels.length > 0 &&
              (this.updateCheckedState('custom'), this.updateMenuButtonCopy('custom'))
          })
        }
        ...
        async submitForm(e) {
          ...
          let s = await i.json(),
            a = o.get('do')
          'string' == typeof a && this.updateCheckedState(a),
            'string' == typeof a && this.updateMenuButtonCopy(a),
            this.updateSocialCount(s.count),
            this.applyInputsCheckedPropertiesToAttributesForNextFormReset(),
            this.closeMenu()
        }
        updateMenuButtonCopy(e) {
          ;(this.unwatchButtonCopy.hidden = !('subscribed' === e || 'custom' === e)),
            (this.stopIgnoringButtonCopy.hidden = 'ignore' !== e),
        ...
        updateSocialCount(e) {
          this.socialCount &&
            ((this.socialCount.textContent = e),
            this.socialCount.setAttribute(
              'aria-label',
              `${this.pluralizeUsers(e)} watching this repository`
            ))
        }
        pluralizeUsers(e) {
        ...
        handleDialogLabelToggle(e) {
          ...
          if (t) {
            ...
            i.removeAttribute('hidden'),
              i.setAttribute(
                'data-targets',
                'notifications-list-subscription-form.subscriptionsLabels'
              ),
              this.subscriptionsContainer.appendChild(i)
        }
        openCustomDialog(e) {
          e.preventDefault(),
            e.stopPropagation(),
        ...
        enableApplyButtonAndCheckbox() {
          ...
          e.length > 0 &&
            ...
            (this.threadTypeCheckboxes[0].checked = !0))
        }
        closeCustomDialog(e) {
          e.preventDefault(),
            e.stopPropagation(),
        ...
        openFilterLabelsDialog(e) {
          e.preventDefault(),
            ...
            this.saveCurrentLabelsState(),
            this.customDialog.toggleAttribute('hidden', !0),
            this.filterLabelsDialog.toggleAttribute('hidden', !1),
            setTimeout(() => {
        ...
        closeFilterLabelsDialog(e) {
          e.preventDefault(),
            ...
            this.menu.toggleAttribute('hidden', !0),
            this.customDialog.toggleAttribute('hidden', !1),
            this.filterLabelsDialog.toggleAttribute('hidden', !0)
        }
        ...
        enableIssuesCheckbox() {
          ...
          e && this.threadTypeCheckboxes.length > 0 && (this.threadTypeCheckboxes[0].checked = e),
        ...
        saveCurrentLabelsState() {
          ...
          for (let e = 0; e < this.subscriptionsLabels.length; e++) {
            let t = this.subscriptionsLabels[e].getAttribute('data-label-id')
            t &&
              ((this.lastAppliedLabels[t] = this.subscriptionsLabels[e].cloneNode(!0)),
              this.appendLabelToFormInput(t))
          }
        }
        appendLabelToFormInput(e) {
          let t = document.createElement('input')
          t.setAttribute('type', 'hidden'),
            t.setAttribute('name', 'labels[]'),
            t.setAttribute('value', e),
            this.labelInputs.appendChild(t)
        }
        detailsToggled() {
      ...
      n([s.fA], r.prototype, 'details', void 0),
        n([s.fA], r.prototype, 'menu', void 0),
        n([s.fA], r.prototype, 'customButton', void 0),
        n([s.fA], r.prototype, 'customDialog', void 0),
        n([s.fA], r.prototype, 'filterLabelsDialog', void 0),
        n([s.GO], r.prototype, 'subscriptionButtons', void 0),
        n([s.GO], r.prototype, 'subscriptionsLabels', void 0),
        n([s.fA], r.prototype, 'labelInputs', void 0),
        n([s.fA], r.prototype, 'subscriptionsSubtitle', void 0),
        n([s.fA], r.prototype, 'socialCount', void 0),
        n([s.fA], r.prototype, 'unwatchButtonCopy', void 0),
        n([s.fA], r.prototype, 'stopIgnoringButtonCopy', void 0),
        n([s.fA], r.prototype, 'watchButtonCopy', void 0),
        n([s.GO], r.prototype, 'threadTypeCheckboxes', void 0),
        n([s.fA], r.prototype, 'customSubmit', void 0),
        n([s.fA], r.prototype, 'subscriptionsContainer', void 0),
        n([s.GO], r.prototype, 'dialogLabelItems', void 0),
        (r = n([s.Ih], r))
      ...
      let p =
        (((i = class NotificationsDialogLabelItemElement extends HTMLElement {
          toggleDropdownLabel(e) {
            if ((e.preventDefault(), e.stopPropagation(), this.label)) {
              let e = 'true' === this.label.getAttribute('aria-checked')
              this.setCheckedForDropdownLabel(!e),
                this.dispatchEvent(
                  new CustomEvent('notifications-dialog-label-toggled', {
                    detail: {
                      wasChecked: e,
        ...
        i)
      d([s.fA], p.prototype, 'label', void 0),
        d([s.fA], p.prototype, 'hiddenLabelTemplate', void 0),
        d([s.fA], p.prototype, 'hiddenCheckboxInput', void 0),
        d([s.Lj], p.prototype, 'labelId', void 0),
        (p = d([s.Ih], p))
      ...
      let b = class NotificationsListSubscriptionFormDialogElement extends HTMLElement {
        ...
        labelFilterUpdated() {
          ...
          for (let t of this.labelCheckboxes) {
            ...
            o.includes(e) || i.includes(e)
              ? t.closest('li').toggleAttribute('hidden', !1)
              : t.closest('li').toggleAttribute('hidden', !0)
          }
        }
      }
      h([s.GO], b.prototype, 'threadTypeCheckboxes', void 0),
        h([s.GO], b.prototype, 'labelCheckboxes', void 0),
        h([s.fA], b.prototype, 'customDialog', void 0),
        h([s.fA], b.prototype, 'labelFilterField', void 0),
        h([s.fA], b.prototype, 'applyButton', void 0),
        (b = h([s.Ih], b))
    },
    58700: (e, t, o) => {
      o.d(t, { Bt: () => l, DN: () => r, KL: () => d, Se: () => n, qC: () => p, sw: () => u })
      var i = o(5582)
      function s(e, t, o) {
        return e.dispatchEvent(new CustomEvent(t, { bubbles: !0, cancelable: o }))
      }
      function l(e, t) {
        t && (a(e, t), (0, i.j)(t)), s(e, 'submit', !0) && e.submit()
      }
      function a(e, t) {
      ...
      function r(e, t) {
        for (let o in t) {
          ...
          s instanceof HTMLInputElement
            ? (s.value = i)
            : s instanceof HTMLTextAreaElement && (s.value = i)
        }
      }
      function u(e) {
...
//# sourceMappingURL=notifications-global-196d5b9dcf98.js.map
