  ...
  ['environment'],
  {
              ...
              (r.prototype.scrollIntoView = function () {
                ...
                var e = (function (e) {
                    for (
                      ...
                      e !== o.body &&
                      !1 ===
                        ((r = s((t = e), 'Y') && u(t, 'Y')), (n = s(t, 'X') && u(t, 'X')), r || n);
                ...
                e !== o.body
                  ? (d.call(this, e, e.scrollLeft + i.left - r.left, e.scrollTop + i.top - r.top),
          ...
          function d(e, r, l) {
            ...
            e === o.body
              ? ((a = t),
                ...
                (d = n.scroll))
              : ((a = e), (s = e.scrollLeft), (u = e.scrollTop), (d = c)),
              (function e(o) {
                var r,
                  n,
                  l,
                  c = (i() - o.startTime) / 468
                ;(r = 0.5 * (1 - Math.cos(Math.PI * (c = c > 1 ? 1 : c)))),
                  (n = o.startX + (o.x - o.startX) * r),
                  (l = o.startY + (o.y - o.startY) * r),
                  o.method.call(o.scrollable, n, l),
                  (n !== o.x || l !== o.y) && t.requestAnimationFrame(e.bind(t, o))
              })({ scrollable: a, method: d, startTime: f, startX: s, startY: u, x: r, y: l })
          }
        },
      }
    },
    ...
    89359: (e, t, o) => {
      ...
      function i() {
        ...
        let o = r('meta[name=analytics-location-params]')
        for (let e of (o && (t += (t ? '&' : '?') + o.content),
        document.querySelectorAll('meta[name=analytics-param-rename]'))) {
          let o = e.content.split(':', 2)
          t = t.replace(RegExp(`(^|[?&])${o[0]}($|=)`, 'g'), `$1${o[1]}$2`)
        }
        return t
      }
      function l() {
        return `${window.location.protocol}//${window.location.host}${n() + i()}`
      }
      o.d(t, { S: () => l })
    },
    24601: (e, t, o) => {
      'use strict'
      o.d(t, { aJ: () => O, cI: () => _, eK: () => v })
      var r = o(82918),
        n = o(49237),
        i = o(28382),
        l = o(89359),
      ...
      function w(e) {
        return { type: e.name, value: e.message, stacktrace: _(e) }
      }
      function T(e, t = {}) {
        return Object.assign(
          {
            error: e,
            sanitizedUrl: (0, l.S)() || window.location.href,
      ...
      function S(e) {
        return e.some((e) => E.test(e.filename) || E.test(e.function))
      }
      function O() {
      ...
      let L = !1
      function P() {
        return !L && !d && f < 10 && (0, n.Gb)()
      }
      if (
        (s.iG?.addEventListener('pageshow', () => (L = !1)),
        s.iG?.addEventListener('pagehide', () => (L = !0)),
    ...
    95253: (e, t, o) => {
      'use strict'
      let r
      o.d(t, { YT: () => f, qP: () => p, yM: () => m })
      var n = o(88149),
        i = o(86058),
        l = o(44544),
        c = o(71643)
      let { getItem: a } = (0, l.Z)('localStorage'),
        s = 'dimension_',
      ...
      function d(e) {
        ...
        if (t)
          ...
          delete t.host,
          Object.entries(t)))
            e.startsWith(s) && ((t[e.replace(s, '')] = o), delete t[e])
        ...
        return (t.staff = (0, c.B)().toString()), Object.assign(t, e)
      }
      function f(e) {
        r?.sendPageView(d(e))
      }
      function p(e, t = {}) {
        ...
        r && (d(n), r.sendEvent(e || 'unknown', d(n)))
      }
      function m(e) {
    ...
    7180: (e, t, o) => {
      'use strict'
      o.d(t, { O: () => u, d: () => TrustedTypesPolicyError })
      var r = o(46426),
        n = o(71643),
        i = o(24601),
        l = o(27856),
      ...
      function s({
        ...
        try {
            ...
            s &&
              new Promise((e) => {
                let o = window.performance.now(),
                  r = c().sanitize(i, { FORBID_ATTR: [] }),
                  n = window.performance.now()
                if (i.length !== r.length) {
                  let l = Error('Trusted Types policy output sanitized'),
                    c = l.stack?.slice(0, 1e3),
                    s = i.slice(0, 250)
                  ;(0, a.qP)('trusted_types_policy.sanitize', {
                    policyName: t,
                    output: s,
                    stack: c,
          ...
          if (
            ...
            (u || (0, i.eK)(e),
            (0, n.b)({ incrementKey: 'TRUSTED_TYPES_POLICY_ERROR', trustedTypesPolicyName: t }),
            !l)
          )
            throw e
        }
    ...
    22490: (e, t, o) => {
      ...
      let l = {
        ...
        c = { createPolicy: (e, t) => ({ name: e, ...l, ...t }) },
        a = new Map(),
        s = globalThis.trustedTypes ?? c,
        u = {
          createPolicy: (e, t) => {
            if (a.has(e))
              return (0, n.b)({ incrementKey: 'TRUSTED_TYPES_POLICY_INITIALIZED_TWICE' }), a.get(e)
            {
    ...
    86058: (e, t, o) => {
      ...
      let AnalyticsClient = class AnalyticsClient {
        ...
        get clientId() {
          return this.options.clientId ? this.options.clientId : (0, a.b)()
        }
        createEvent(e) {
          return {
            page: location.href,
        ...
        sendEvent(e, t) {
          let o = { ...this.createEvent(t), type: e }
          this.send({ events: [o] })
        }
        send({ page_views: e, events: t }) {
          let o = { client_id: this.clientId, page_views: e, events: t, request_context: c() },
            r = JSON.stringify(o)
          try {
...
//# sourceMappingURL=environment-98c1dc06fc95.js.map
