  ...
  ],
  {
    65935: (e, t, n) => {
      ...
      function d(e, t) {
        r ||
          ((r = new Map()),
          'undefined' != typeof document && document.addEventListener('submit', f))
        let n = r.get(e) || []
        r.set(e, [...n, t])
      }
      function h(e) {
    ...
    59753: (e, t, n) => {
        ...
        (r.prototype.add = function (e, t) {
          ...
          if ('string' == typeof e) {
            for (
              ...
              (s = (u = l[r]).key),
                (a = h(f, (i = u.index))) || (((a = Object.create(i)).map = new o()), f.push(a)),
                ...
                if (((a = u[i]), r.index.isPrototypeOf(a))) {
                  if ((c = a.map.get(r.key)))
                    for (s = c.length; s--; )
                      (l = c[s]).selector === e &&
                        (m || l.data === t) &&
                        (c.splice(s, 1), (p[l.id] = !0))
                  break
                }
            for (o in p) delete f[o], this.size--
            for (o in f) h.push(f[o].selector)
          }
        }),
      ...
      function T(e) {
        if (j(e)) {
          ...
          if (t) {
            var n = x(t, e.target, 1 === e.eventPhase)
            if (n.length) {
              b(e, 'stopPropagation', E), b(e, 'stopImmediatePropagation', k), _(e, S)
              for (var r = 0, o = n.length; r < o && !g.get(e); r++) {
                var i = n[r]
                y.set(e, i.node)
                for (var s = 0, a = i.observers.length; s < a && !v.get(e); s++)
    ...
    86058: (e, t, n) => {
      ...
      let AnalyticsClient = class AnalyticsClient {
        ...
        get clientId() {
          return this.options.clientId ? this.options.clientId : (0, c.b)()
        }
        createEvent(e) {
          return {
            page: location.href,
