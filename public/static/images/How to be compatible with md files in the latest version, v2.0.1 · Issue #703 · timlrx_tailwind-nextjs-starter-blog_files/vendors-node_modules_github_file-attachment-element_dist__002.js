...
;(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
  ...
  ],
  {
    57260: (e, t, n) => {
      ...
      let Attachment = class Attachment {
        ...
        static from(e) {
          let t = []
          for (let n of e)
            if (n instanceof File) t.push(new Attachment(n))
            else if (n instanceof Attachment) t.push(n)
        ...
        saved(e) {
          ...
          ;(this.state = 'saved'),
            (this.id = null !== (t = null == e ? void 0 : e.id) && void 0 !== t ? t : null),
            (this.href = null !== (n = null == e ? void 0 : e.href) && void 0 !== n ? n : null),
            (this.name = null !== (i = null == e ? void 0 : e.name) && void 0 !== i ? i : null)
        }
        isPending() {
      ...
      function i(e, t) {
        return t && c(e)
          ? l('', u(e))
          : Promise.resolve(s(Array.from(e.files || [])).map((e) => new Attachment(e)))
      }
      function r(e) {
        return e.name.startsWith('.')
      }
      function s(e) {
        return Array.from(e).filter((e) => !r(e))
      }
      function o(e) {
      ...
      let FileAttachmentElement = class FileAttachmentElement extends HTMLElement {
        connectedCallback() {
          this.addEventListener('dragenter', h),
            this.addEventListener('dragover', h),
            this.addEventListener('dragleave', p),
            this.addEventListener('drop', m),
            this.addEventListener('paste', b),
            this.addEventListener('change', y)
        }
        disconnectedCallback() {
          this.removeEventListener('dragenter', h),
            this.removeEventListener('dragover', h),
            this.removeEventListener('dragleave', p),
            this.removeEventListener('drop', m),
            this.removeEventListener('paste', b),
            this.removeEventListener('change', y)
        }
        get directory() {
        ...
        async attach(e) {
          let t =
              e instanceof DataTransfer
                ? await Attachment.traverse(e, this.directory)
                : Attachment.from(e),
      ...
      function h(e) {
        ...
        f && clearTimeout(f), (f = window.setTimeout(() => t.removeAttribute('hover'), 200))
        let n = e.dataTransfer
        n && d(n) && ((n.dropEffect = 'copy'), t.setAttribute('hover', ''), e.preventDefault())
      }
      function p(e) {
        e.dataTransfer && (e.dataTransfer.dropEffect = 'none')
        let t = e.currentTarget
        t.removeAttribute('hover'), e.stopPropagation(), e.preventDefault()
      }
      function m(e) {
        let t = e.currentTarget
        ...
        let n = e.dataTransfer
        n && d(n) && (t.attach(n), e.stopPropagation(), e.preventDefault())
      }
      let v = /^image\/(gif|png|jpeg)$/
      function g(e) {
        for (let t of e) if ('file' === t.kind && v.test(t.type)) return t.getAsFile()
        return null
      }
      function b(e) {
        ...
        let t = e.currentTarget
        if (!(t instanceof FileAttachmentElement)) return
        let n = g(e.clipboardData.items)
        n && (t.attach([n]), e.preventDefault())
      }
      function y(e) {
        let t = e.currentTarget
        if (!(t instanceof FileAttachmentElement)) return
        ...
        let i = t.getAttribute('input')
        if (i && n.id !== i) return
        let r = n.files
        r && 0 !== r.length && (t.attach(r), (n.value = ''))
      }
    ...
    3447: (e, t, n) => {
      ...
      function r(e = 0, t = {}) {
        return (n, r, s) => {
          if (!s || 'function' != typeof s.value)
            throw Error('debounce can only decorate functions')
          let o = s.value
          ;(s.value = (0, i.D)(o, e, t)), Object.defineProperty(n, r, s)
        }
      }
    },
    98105: (e, t, n) => {
      ...
      function r(e) {
        ...
        if (t !== n.body) {
          for (; t !== n.body; ) {
            if (!(t.parentElement instanceof i)) return
            t = t.parentElement
            let { position: e, overflowY: n, overflowX: r } = getComputedStyle(t)
            if ('fixed' === e || 'auto' === n || 'auto' === r || 'scroll' === n || 'scroll' === r)
              break
          }
      ...
      function s(e, t) {
        let n = t,
          i = e.ownerDocument
        if (!i) return
        let r = i.documentElement
        if (!r || e === r) return
        let s = o(e, n)
        if (!s) return
        n = s._container
        let a =
            n === i.documentElement && i.defaultView
              ? { top: i.defaultView.pageYOffset, left: i.defaultView.pageXOffset }
              : { top: n.scrollTop, left: n.scrollLeft },
          l = s.top - a.top,
          c = s.left - a.left,
          u = n.clientHeight,
          d = n.clientWidth,
          f = u - (l + e.offsetHeight),
          h = d - (c + e.offsetWidth)
        return { top: l, left: c, bottom: f, right: h, height: u, width: d }
      }
      function o(e, t) {
        let n,
          i,
          ...
          o = s.ownerDocument
        if (!o) return
        let c = o.documentElement
        if (!c) return
        let u = o.defaultView.HTMLElement,
          d = 0,
          f = 0,
          h = s.offsetHeight,
          p = s.offsetWidth
        for (; !(s === o.body || s === t); ) {
          if (((d += s.offsetTop || 0), (f += s.offsetLeft || 0), !(s.offsetParent instanceof u)))
            return
          s = s.offsetParent
        }
        if (t && t !== o && t !== o.defaultView && t !== o.documentElement && t !== o.body) {
          if (!(t instanceof u)) return
          ;(r = t), (n = t.scrollHeight), (i = t.scrollWidth)
        } else (r = c), (n = a(o.body, c)), (i = l(o.body, c))
        let m = n - (d + h),
          v = i - (f + p)
        return { top: d, left: f, bottom: m, right: v, _container: r }
      }
      function a(e, t) {
        return Math.max(
          e.scrollHeight,
    ...
    48858: (e, t, n) => {
      ...
      function l(e, t, n) {
        ...
        if (i) {
          let e = i
          i.container.setAttribute('data-focus-trap', 'suspended'), i.controller.abort(), s.push(e)
        }
        p.signal.addEventListener('abort', () => {
          ...
          u.addEventListener('abort', () => {
            ...
            let t = e.getElementsByClassName('sentinel')
            for (; t.length > 0; ) t[0].remove()
            let n = s.findIndex((t) => t.container === e)
            n >= 0 && s.splice(n, 1), o()
          }),
          ...
          (i = { container: e, controller: p, initialFocus: t, originalSignal: u })
        let m = s.findIndex((t) => t.container === e)
        if ((m >= 0 && s.splice(m, 1), !n)) return c
      }
    },
    44542: (e, t, n) => {
      n.d(t, { O: () => a })
      ...
      try {
        ...
        window.addEventListener('test', r, e), window.removeEventListener('test', r, e)
      } catch (e) {}
      function s() {
        return i
      }
      function o() {
        ...
        EventTarget.prototype.addEventListener = function (t, n, i) {
          return (
            'object' == typeof i &&
              'signal' in i &&
              i.signal instanceof AbortSignal &&
              e.call(i.signal, 'abort', () => {
    ...
    78160: (e, t, n) => {
      function* i(e, t = {}) {
        var n, i
        let r = null !== (n = t.strict) && void 0 !== n && n,
          a = null !== (i = t.onlyTabbable) && void 0 !== i && i ? o : s,
          l = document.createTreeWalker(e, NodeFilter.SHOW_ELEMENT, {
            acceptNode: (e) =>
              e instanceof HTMLElement && a(e, r)
                ? NodeFilter.FILTER_ACCEPT
                : NodeFilter.FILTER_SKIP,
          }),
          c = null
        if ((!t.reverse && a(e, r) && (yield e), t.reverse)) {
          let e = l.lastChild()
          for (; e; ) (c = e), (e = l.lastChild())
        } else c = l.firstChild()
        for (; c instanceof HTMLElement; )
          yield c, (c = t.reverse ? l.previousNode() : l.nextNode())
        t.reverse && a(e, r) && (yield e)
      }
      function r(e, t = !1) {
        return i(e, { reverse: t, strict: !0, onlyTabbable: !0 }).next().value
      }
      function s(e, t = !1) {
        let n =
          ...
          s = e.classList.contains('sentinel')
        if (n || i || r || s) return !1
        if (t) {
          let t = 0 === e.offsetWidth || 0 === e.offsetHeight,
            n = ['hidden', 'collapse'].includes(getComputedStyle(e).visibility),
            i = 0 === e.getClientRects().length
          if (t || n || i) return !1
        }
        return (
      ...
      function o(e, t = !1) {
        return s(e, t) && '-1' !== e.getAttribute('tabindex')
      }
      n.d(t, { EB: () => s, O: () => r, Wq: () => o, hT: () => i })
    },
    59753: (e, t, n) => {
      function i() {
      ...
      function d(e, t) {
        ...
        do
          if ((u.exec(''), (r = u.exec(c)) && ((c = r[3]), r[2] || !c))) {
            for (n = 0; n < l; n++)
              if ((o = (a = e[n]).selector(r[1]))) {
                for (i = d.length, s = !1; i--; )
                  if (d[i].index === a && d[i].key === o) {
                    s = !0
                    break
                  }
                s || d.push({ index: a, key: o })
                break
              }
          }
        while (r)
      ...
      function f(e, t) {
        var n, i, r
        for (n = 0, i = e.length; n < i; n++) if (((r = e[n]), t.isPrototypeOf(r))) return r
      }
      function h(e, t) {
        return e.id - t.id
      }
      ;(i.prototype.logDefaultIndexUsed = function () {}),
        (i.prototype.add = function (e, t) {
          ...
          if ('string' == typeof e) {
            for (
              i = 0,
                m[(n = { id: this.uid++, selector: e, data: t }).id] = n,
                c = d(this.indexes, e);
              i < c.length;
              i++
            )
              (o = (u = c[i]).key),
                (a = f(h, (s = u.index))) || (((a = Object.create(s)).map = new r()), h.push(a)),
                s === this.indexes.default && this.logDefaultIndexUsed(n),
                (l = a.map.get(o)) || ((l = []), a.map.set(o, l)),
                l.push(n)
            this.size++, p.push(e)
          }
        }),
        ...
        (i.prototype.queryAll = function (e) {
          ...
          for (t = 0, i = d.length; t < i; t++)
            for (n = 0, s = d[t], r = (o = this.matches(s)).length; n < r; n++)
              c[(l = o[n]).id]
                ? (a = c[l.id])
                : ((a = { id: l.id, selector: l.selector, data: l.data, elements: [] }),
                  (c[l.id] = a),
                  u.push(a)),
                a.elements.push(s)
          return u.sort(h)
      ...
      function S(e) {
        if (k(e)) {
          ...
          if (t) {
            var n = A(t, e.target, 1 === e.eventPhase)
            if (n.length) {
              E(e, 'stopPropagation', w), E(e, 'stopImmediatePropagation', T), L(e, x)
              for (var i = 0, r = n.length; i < r && !v.get(e); i++) {
                var s = n[i]
                b.set(e, s.node)
                for (var o = 0, a = s.observers.length; o < a && !g.get(e); o++)
                  s.observers[o].data.call(s.node, e)
              }
              b.delete(e), L(e)
            }
          }
      ...
      function O(e, t, n) {
        var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
          ...
          o = s ? m : p,
          a = o[e]
        a || ((a = new i()), (o[e] = a), document.addEventListener(e, S, s)), a.add(t, n)
      }
      function C(e, t, n) {
        var i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
          ...
          s = r ? m : p,
          o = s[e]
        o && (o.remove(t, n), o.size || (delete s[e], document.removeEventListener(e, S, r)))
      }
      function H(e, t, n) {
        return e.dispatchEvent(new CustomEvent(t, { bubbles: !0, cancelable: !0, detail: n }))
      }
    },
    10160: (e, t, n) => {
      n.d(t, { Z: () => Combobox })
      let Combobox = class Combobox {
        constructor(e, t, { tabInsertsSuggestions: n, defaultFirstOption: r } = {}) {
          ;(this.input = e),
            (this.list = t),
            (this.tabInsertsSuggestions = null == n || n),
            (this.defaultFirstOption = null != r && r),
            (this.isComposing = !1),
            t.id || (t.id = `combobox-${Math.random().toString().slice(2, 6)}`),
            (this.ctrlBindings = !!navigator.userAgent.match(/Macintosh/)),
            (this.keyboardEventHandler = (e) => i(e, this)),
            (this.compositionEventHandler = (e) => l(e, this)),
        ...
        navigate(e = 1) {
          let t = Array.from(this.list.querySelectorAll('[aria-selected="true"]')).filter(a)[0],
            n = Array.from(this.list.querySelectorAll('[role="option"]')).filter(a),
            i = n.indexOf(t)
      ...
      function r(e) {
        ...
        t && 'true' !== t.getAttribute('aria-disabled') && o(t, { event: e })
      }
      function s(e, t) {
    ...
    11793: (e, t, n) => {
      ...
      let RadixTrie = class RadixTrie {
        ...
        insert(e) {
          ...
          for (let n = 0; n < e.length; n += 1) {
            ...
            if (n === e.length - 1)
              return (
                r instanceof RadixTrie && (t.delete(r), (r = null)),
                r || ((r = new Leaf(t)), (t.children[i] = r)),
                r
              )
            r instanceof Leaf && (r = null),
              r || ((r = new RadixTrie(t)), (t.children[i] = r)),
              (t = r)
          }
          return t
        }
      ...
      function i(e) {
        let { ctrlKey: t, altKey: n, metaKey: i, key: o } = e,
          a = [],
          l = [t, n, i, s(e)]
        for (let [e, t] of l.entries()) t && a.push(r[e])
        return r.includes(o) || a.push(o), a.join('+')
      }
      let r = ['Control', 'Alt', 'Meta', 'Shift']
      function s(e) {
        let { shiftKey: t, code: n, key: i } = e
        return t && !(n.startsWith('Key') && i.toUpperCase() === i)
      }
      function o(e, t) {
        return c(l(e, t))
      }
      ...
      let SequenceTracker = class SequenceTracker {
        ...
        registerKeypress(e) {
          ;(this._path = [...this._path, i(e)]), this.startTimer()
        }
        reset() {
          var e
          this.killTimer(),
      ...
      function f(e) {
        ...
        for (let r = 0; r < e.length; r++) {
          ...
          ;(i = '+' !== e[r]), (n[n.length - 1] += e[r])
        }
        return (
          t.push(n),
          t.map((e) => e.map((e) => o(e)).filter((e) => '' !== e)).filter((e) => e.length > 0)
        )
      }
      ...
      function g(e) {
        ...
        if ((v.registerKeypress(e), (m = t), t instanceof Leaf)) {
          let n
          let i = e.target,
            r = !1,
            s = u(i)
          ...
          n && r && (d(n, v.path), e.preventDefault()), v.reset()
        }
      }
      function b(e, t) {
        0 === Object.keys(h.children).length && document.addEventListener('keydown', g)
        let n = f(t || e.getAttribute('data-hotkey') || ''),
          i = n.map((t) => h.insert(t).add(e))
        p.set(e, i)
      }
      function y(e) {
        let t = p.get(e)
        if (t && t.length) for (let n of t) n && n.delete(e)
        0 === Object.keys(h.children).length && document.removeEventListener('keydown', g)
      }
    },
  },
])
