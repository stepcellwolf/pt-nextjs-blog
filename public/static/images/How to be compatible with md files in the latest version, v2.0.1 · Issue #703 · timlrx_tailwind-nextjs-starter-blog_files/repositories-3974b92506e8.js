...
;(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
  ...
  ],
  {
    34892: (e, t, r) => {
      ...
      let i = class ResponseError extends Error {
        constructor(e, t) {
      ...
      function a(e, t, r = !1) {
        ...
        if (!r && !n.startsWith('text/html'))
          throw new i(`expected response with text/html, but was ${n}`, t)
        if (r && !(n.startsWith('text/html') || n.startsWith('application/json')))
          throw new i(`expected response with text/html or application/json, but was ${n}`, t)
        let o = t.headers.get('x-html-safe')
        if (o) {
          if (!e.includes(o)) throw new i('response X-HTML-Safe nonce did not match', t)
        } else throw new i('missing X-HTML-Safe nonce', t)
      }
      var s = r(22490),
        l = r(7180)
      let c = 'server-x-safe-html',
        d = s.ZO.createPolicy(c, {
          createHTML: (e, t) =>
            l.O.apply({
              policy: () => (a(o(document), t), e),
              policyName: c,
              fallback: e,
      ...
      async function u(e, t, r) {
        ...
        let a = d.createHTML(await i.text(), i)
        return (0, n.r)(e, a)
      }
      function f(e, t, r = 1e3, n = [200]) {
        return (async function r(o) {
          let i = new Request(e, t)
          i.headers.append('X-Requested-With', 'XMLHttpRequest')
          let a = await self.fetch(i)
          if (202 === a.status) return await new Promise((e) => setTimeout(e, o)), r(1.5 * o)
          if (n.includes(a.status)) return a
          if (a.status < 200 || a.status >= 300)
            throw Error(`HTTP ${a.status}${a.statusText || ''}`)
          throw Error(`Unexpected ${a.status} response status from poll endpoint`)
        })(r)
      }
      async function p(e, t, r) {
        let { wait: n = 500, acceptedStatusCodes: o = [200], max: i = 3, attempt: a = 0 } = r || {},
          s = async () =>
            new Promise((r, s) => {
              setTimeout(async () => {
                try {
        ...
        return 'retry' !== l
          ? l
          : p(e, t, { wait: n, acceptedStatusCodes: o, max: i, attempt: a + 1 })
      }
    },
    9302: (e, t, r) => {
      let n, o
      r.d(t, { lO: () => p, qA: () => f, y0: () => s })
      let i = [],
        a = 0
      function s() {
        return n
      ...
      function f(e, t, r) {
        a = 0
        let n = { _id: u(), ...e }
        history.pushState(n, t, r), d(n)
      }
      function p(e, t, r) {
        let n = { ...s(), ...e }
        history.replaceState(n, t, r), d(n)
      }
      ;(n = (function () {
        ...
        window.addEventListener(
          ...
          function (e) {
            ...
            let r = t.turbo?.restorationIdentifier,
              n = i[c() - 1]?.state?.turbo?.restorationIdentifier
            n === r ? a-- : a++, d(t)
          },
          !0
        ),
        ...
        window.addEventListener(
          ...
          function () {
            if (l() > i.length) {
              let e = { _id: u() }
              history.replaceState(e, '', location.href), d(e)
            }
          },
          !0
        ),
    ...
    55843: (e, t, r) => {
      ...
      let i = class InputDemuxElement extends HTMLElement {
        ...
        relayInput(e) {
          ...
          let t = e.target,
            r = t.value
          this.routeCustomEvent(new CustomEvent('input-entered', { detail: r }))
        }
        routeCustomEvent(e) {
      ...
      o([n.fA], i.prototype, 'source', void 0),
        o([n.GO], i.prototype, 'sinks', void 0),
        o([n.fA], i.prototype, 'control', void 0),
        (i = o([n.Ih], i))
    },
    4738: (e, t, r) => {
      r.d(t, {
      ...
      function g(e) {
        e instanceof MouseEvent &&
          ((h.x !== e.clientX || h.y !== e.clientY) && (m = !1),
      ...
      function w(e) {
        let t = e.modifierKey || e.altKey || e.ctrlKey || e.metaKey,
          r = (0, o.f)(e.currentTarget, 'navigation:open', { modifierKey: t, shiftKey: e.shiftKey })
        r || e.preventDefault()
      }
      function j(e) {
        let t = M()
        ...
        (0, o.on)('navigation:keydown', '.js-active-navigation-container', function (e) {
          ...
          if ((0, s.Zf)(e.detail.originalEvent)) {
            if (n.classList.contains('js-navigation-item')) {
              ...
              if (n) {
                if (r)
                  u && 'Control+n' === (0, a.EL)(e.detail.originalEvent) && R(n, t),
                    'ArrowDown' === (0, a.EL)(e.detail.originalEvent) && R(n, t)
                else {
                  if (u)
                    switch ((0, a.EL)(e.detail.originalEvent)) {
                      case 'Control+n':
      ...
      function A(e, t) {
        let r = O(e)[0],
          n = (t || e).closest('.js-navigation-item') || r
        if ((j(e), n instanceof HTMLElement)) {
          let t = R(n, e)
          if (t) return
          let r = (0, i.VZ)(n)
          N(r, n)
      ...
      function x(e, t) {
        ...
        let o = O(t),
          ...
          s = (0, i.VZ)(e)
        if (null != s) {
          for (; (r = o[a - 1]) && (n = (0, i._C)(r, s)) && n.top >= 0; ) a--
          if (r) {
            let e = R(r, t)
            if (e) return
            P(s, r)
      ...
      function D(e, t) {
        ...
        let o = O(t),
          ...
          s = (0, i.VZ)(e)
        if (null != s) {
          for (; (r = o[a + 1]) && (n = (0, i._C)(r, s)) && n.bottom >= 0; ) a++
          if (r) {
            let e = R(r, t)
            if (e) return
            P(s, r)
      ...
      function I(e, t = !1) {
        ;(0, o.f)(e, 'navigation:keyopen', { modifierKey: t })
      }
      function R(e, t) {
      ...
      function O(e) {
        let t = []
        for (let r of e.querySelectorAll('.js-navigation-item'))
          r instanceof HTMLElement && (0, d.Z)(r) && t.push(r)
        return t
      }
      function H(e) {
        return e.getAttribute('data-navigation-scroll') || 'item'
      }
      function P(e, t, r = 'smooth') {
        let n = (0, i._C)(t, e)
        n &&
          (n.bottom <= 0
            ? t.scrollIntoView({ behavior: r, block: 'start' })
            : n.top <= 0 && t.scrollIntoView({ behavior: r, block: 'end' }))
      }
      function N(e, t) {
        let r = (0, i.oE)(t, e),
          n = (0, i._C)(t, e)
        if (null != r && null != n) {
          if (n.bottom <= 0 && document.body) {
            ...
            c(e, { top: o })
          } else n.top <= 0 && c(e, { top: r.top })
        }
      }
    },
    254: (e, t, r) => {
      r.d(t, { ZG: () => s, q6: () => c, w4: () => l })
      var n = r(8439)
      let o = !1,
        i = new n.Z()
      function a(e) {
      ...
      function s(e, t) {
        o || ((o = !0), document.addEventListener('focus', a, !0)),
          i.add(e, t),
    ...
    41246: (e, t, r) => {
      ...
      let { getItem: l, setItem: c } = (0, i.Z)('localStorage'),
        d = 'code-button-default-tab',
        u = class GetRepoElement extends HTMLElement {
          ...
          showCodespaceSelector(e) {
            let t = this.findPlatform(e)
            t &&
              (this.showPlatform(t), this.codespaceSelector && (this.codespaceSelector.hidden = !1))
          }
          ...
          hideSpinner() {
            this.codespaceLoadingMenu && (this.codespaceLoadingMenu.hidden = !0),
              this.codespaceList && (this.codespaceList.hidden = !1)
          }
          showSpinner() {
            this.codespaceLoadingMenu && (this.codespaceLoadingMenu.hidden = !1),
              this.codespaceList && (this.codespaceList.hidden = !0)
          }
          onDetailsToggle(e) {
            for (let e of ((this.modal.hidden = !1), this.platforms)) e.hidden = !0
            let t = e.target
            if (t && t.open) {
              !this.hasForcedCodespaceTabDefault && this.forceCodespaceTabDefault
                ? ((this.hasForcedCodespaceTabDefault = !0), this.selectDefaultTab(!0))
          ...
          showPlatform(e) {
            for (let t of ((this.modal.hidden = !0), this.platforms))
              t.hidden = t.getAttribute('data-platform') !== e
          }
          findPlatform(e) {
          ...
          cloudTabSelected() {
            c(d, 'cloud'),
              this.codespaceList?.id === 'lazyLoadedCodespacesList' && this.loadAndUpdateContent()
          }
          selectDefaultTab(e) {
            let t = e ? 'cloud' : l(d)
            if (!t) return
          ...
          constructor(...e) {
            super(...e),
              ...
              (this.hasForcedCodespaceTabDefault = !1),
              (this.forceCodespaceTabDefault = !1)
          }
        }
      s([n.Lj], u.prototype, 'forceCodespaceTabDefault', void 0),
        s([n.fA], u.prototype, 'modal', void 0),
        s([n.fA], u.prototype, 'codespaceForm', void 0),
        s([n.fA], u.prototype, 'codespaceLoadingMenu', void 0),
        s([n.fA], u.prototype, 'codespaceList', void 0),
        s([n.fA], u.prototype, 'codespaceSelector', void 0),
        s([n.fA], u.prototype, 'openOrCreateInCodespace', void 0),
        s([n.fA], u.prototype, 'vscodePoller', void 0),
        s([n.GO], u.prototype, 'platforms', void 0),
        s([n.fA], u.prototype, 'copilotTip', void 0),
        (u = s([n.Ih], u))
    },
    1883: (e, t, r) => {
      var n = r(13002),
    ...
    58541: (e, t, r) => {
      ...
      ;(0, n.N7)('#js-spoofed-commit-warning-trigger', { add: o })
    },
    97629: (e, t, r) => {
      function n(e) {
    ...
    63746: (e, t, r) => {
      ...
      let u = class BranchFilterElement extends HTMLElement {
        ...
        async search() {
          ...
          let e = this.field.value.trim().length > 0,
            t = f(this.field)
          for (let t of (this.classList.toggle('is-search-mode', e),
          ...
          let { signal: r } = (this.abortSearch = new AbortController())
          try {
            let e = await (0, s.a_)(document, t, { signal: r })
      ...
      function f(e) {
        ...
        if (r) {
          ...
          return (
            o instanceof HTMLInputElement && n.append('utf8', o.value),
            n.append('query', r),
            (e.search = n.toString()),
            e.toString()
          )
      ...
      d([o.fA], u.prototype, 'field', void 0),
        d([o.fA], u.prototype, 'result', void 0),
        d([o.fA], u.prototype, 'allFilter', void 0),
        d([o.GO], u.prototype, 'filters', void 0),
        d([(0, i.D)(100)], u.prototype, 'search', null),
        (u = d([o.Ih], u))
      var p = r(15345),
        m = function (e, t, r, n) {
          var o,
      ...
      let h = class BranchFilterItemElement extends HTMLElement {
        ...
        loading(e) {
          for (let t of this.branches)
            e ? t.spinner.removeAttribute('hidden') : t.spinner.setAttribute('hidden', 'true'),
              t.destroyButton && (t.destroyButton.hidden = e)
        }
        set mode(e) {
        ...
        async destroy(e) {
          ...
          if (!t || !t.ok) {
            this.displayServerError(!0, t?.status === 404),
              this.disableAllDeleteButtons(!1),
              this.loading(!1)
            return
          }
          ...
          r
            ? (this.setUpDialog(r),
              ...
              this.disableAllDeleteButtons(!1))
            : (this.disableAllDeleteButtons(!1), await this.confirmDeletion())
        }
        async confirmDeletion() {
          ...
          ;(0, p.x)(`Branch ${this.branch} deleted`),
            this.loading(!1),
            (this.mode = 'restore'),
        ...
        setUpDialog(e) {
          ...
          ;(t.querySelector('.js-delete-dialog-body').innerHTML = e),
            t.addEventListener('close', this.closeHandler),
            t.addEventListener('cancel', this.cancelHandler)
        }
        handleDialogClose() {
        ...
        removeDialogEventListeners() {
          ...
          e.removeEventListener('close', this.closeHandler),
            e.removeEventListener('cancel', this.cancelHandler)
        }
        disableAllDeleteButtons(e) {
          for (let t of document.querySelectorAll('.js-branch-delete-button'))
            (t.disabled = e), e ? t.classList.add('disabled') : t.classList.remove('disabled')
        }
        displayServerError(e, t = !1) {
          ...
          e
            ? t
              ? ((n.querySelector('.js-branch-delete-warning-name').textContent = this.branch),
                (n.hidden = !1))
              : ((r.querySelector('.js-branch-delete-error-name').textContent = this.branch),
                (r.hidden = !1))
            : ((r.hidden = !0), (n.hidden = !0))
        }
        constructor(...e) {
          super(...e),
            (this.closeHandler = () => this.handleDialogClose()),
            (this.cancelHandler = () => this.handleDialogCancel())
        }
      }
      m([o.fA], h.prototype, 'destroyButton', void 0),
        m([o.fA], h.prototype, 'restoreButton', void 0),
        m([o.fA], h.prototype, 'spinner', void 0),
        (h = m([o.Ih], h))
      var g = r(36071)
      ;(0, g.N7)('.js-new-badge-autodismiss', {
        ...
        (0, g.N7)('.js-fetch-upstream-details-content', {
        ...
        (0, l.on)('click', '.js-fetch-upstream-summary', async function () {
          ...
          let a = r.getAttribute('data-mergeability-check-url'),
            s = await fetch(a, { headers: { Accept: 'application/json' } })
      ...
      var y = r(56959),
        v = r(65935),
        b = r(58700)
      ;(0, g.N7)('.repository-import', {
        subscribe: (e) =>
          (0, y.RB)(e, 'socket:message', function (e) {
            let t = e.detail.data
            t.redirect_to &&
              ((document.location.href = t.redirect_to), e.stopImmediatePropagation())
          }),
      }),
        (0, l.on)('change', 'input.js-repository-import-lfs-opt', function ({ currentTarget: e }) {
          let t = parseInt(e.getAttribute('data-percent-used') || ''),
            r = e.closest('.js-repository-import-lfs-container'),
            n = e.getAttribute('data-used') || ''
          r.querySelector('.js-repository-import-lfs-warn').classList.toggle('d-none', !(t > 100)),
            r.querySelector('.js-usage-bar').classList.toggle('exceeded', t >= 100),
            r.querySelector('.js-usage-bar').setAttribute('aria-label', `${t}%`),
            (r.querySelector('.js-repository-import-lfs-progress').style.width = `${t}%`),
            (r.querySelector('span.js-usage-text').textContent = n)
        }),
        (0, v.AC)('.js-repository-import-author-form', async function (e, t) {
          let r = await t.html(),
        ...
        (0, g.N7)('.js-branch-merge-queue-link', {
          subscribe: (e) =>
            (0, y.RB)(e, 'socket:message', async function (t) {
      ...
      function L() {
        ...
        let s = t.getAttribute('data-business-id'),
          ...
          m = document.querySelector('.js-private-restricted-by-policy-description')
        _(d, u, f, p, m), k(), C()
        let h = 'false' !== t.getAttribute('data-org-private-restricted-by-plan'),
        ...
        d || !h
          ? (g && (g.hidden = !0), b && (b.hidden = !0), w && (w.hidden = !0))
          : (m && (m.hidden = h), g && (g.hidden = !1), b && (b.hidden = !y), w && (w.hidden = y)),
          T(t)
        let j = t.getAttribute('data-default-new-repo-branch'),
          S = document.querySelector('.js-new-repo-owner-default-branch')
        S && (S.textContent = j)
        let q = t.getAttribute('data-owner-settings-link-prefix'),
          L = document.querySelector('.js-new-repo-owner-settings-link-prefix')
        L && (L.textContent = q)
        let E = t.getAttribute('data-owner-settings-url'),
          A = document.querySelector('.js-repo-owner-default-branch-settings-link-container'),
          x = document.querySelector('.js-org-repo-owner-default-branch-settings-info')
        if (E) {
          let e = document.querySelector('.js-new-repo-owner-settings-link')
          e && ((e.href = E), A && (A.hidden = !1)), x && (x.hidden = !0)
        } else if (A && ((A.hidden = !0), x)) {
          let e = t.hasAttribute('data-viewer-is-org-admin')
          x.hidden = !e
        }
        let D = 'true' === t.getAttribute('data-org-show-trade-controls'),
          N = 'true' === t.getAttribute('data-viewer-is-org-admin'),
          $ = 'true' === t.getAttribute('data-user-show-trade-controls'),
          B = D && !d,
          U = document.querySelector('.js-trade-controls-description'),
          F = document.querySelector('.js-individual-trade-controls-description')
        $ || B
          ? (m && ($ || N || !B ? (m.hidden = !0) : (m.hidden = !1)),
            (u.disabled = !0),
            p && (p.hidden = !0),
            g && (g.hidden = !0),
            b && (b.hidden = !0),
            w && (w.hidden = !0))
          : (U && (U.hidden = !0), F && (F.hidden = !0)),
          $
            ? (U && (U.hidden = !0), F && (F.hidden = !1))
            : B && U && (F && (F.hidden = !0), N ? (U.hidden = !1) : (U.hidden = !0)),
          I(t, n, c, u),
          O('yes' === t.getAttribute('data-permission')),
          M(t),
          H()
        let W = document.querySelector('.js-quick-install-container')
        if (W) {
          let e = W.querySelector('.js-quick-install-divider')
          e.hidden = !0
          ...
          if (r) {
            ...
            if (t instanceof HTMLTemplateElement) {
              let r = W.querySelector('.js-account-apps')
              ;(r.textContent = ''),
                r.append(t.content.cloneNode(!0)),
                t.children.length > 0 && (e.hidden = !1)
            }
          }
        }
        P()
      ...
      function E(e, t) {
        ...
        if (s) {
          ...
          s.textContent =
            ((l = `You are creating a${t} repository`), o ? `${l} in ${i}${a}.` : `${l}.`)
          return
        }
      }
      function A(e) {
      ...
      function _(e, t, r, n, o) {
        e
          ? (t && (t.disabled = !1),
            r && r.classList.remove('color-fg-muted'),
            n && (n.hidden = !1),
            o && (o.hidden = !0))
          : (t && (t.disabled = !0),
            r && r.classList.add('color-fg-muted'),
            n && (n.hidden = !0),
            o && (o.hidden = !1))
      }
      function k() {
      ...
      function x() {
        return document.querySelector('.js-owner-container [aria-checked="true"]')
      }
      function D() {
        return document.querySelector('.js-owner-reponame .js-repo-name')
      }
      function I(e, t, r, n) {
        let o = null
        if (
        ...
        let i =
            ...
            (n.disabled && n.checked) ||
            (r && r.disabled && r.checked),
            ...
            if (a instanceof HTMLInputElement)
              return (
                'false' === t.getAttribute('data-org-allow-internal-repos')
                  ? ((a.disabled = !0),
                    e && e.classList.add('color-fg-muted'),
                    o && (o.hidden = !0),
                    i && (i.hidden = !1))
                  : (r && ((a.checked = !0), (0, l.f)(a, 'change')),
                    (a.disabled = !1),
                    e && e.classList.remove('color-fg-muted'),
                    o && (o.hidden = !1),
                    i && (i.hidden = !0)),
                a
              )
      ...
      function M(e) {
        ...
        o
          ? (n && t.setAttribute('src', n), t.removeAttribute('disabled-src'))
          : (r && t.setAttribute('disabled-src', r), t.removeAttribute('src'))
      }
      function O(e) {
      ...
      ;(0, g.N7)('.js-page-new-repo', function () {
      ...
      ;(0, l.on)('focusout', '#repository-owner', function () {
        ...
        (0, l.on)('click', '.js-reponame-suggestion', function (e) {
          ...
          ;(t.value = e.currentTarget.textContent), k(), (0, l.f)(t, 'input', !1)
        }),
        (0, l.on)('click', '.js-use-pages-url', function (e) {
          let t = e.currentTarget,
            r = document.querySelector('.js-pages-url-input'),
            n = document.getElementById('page-url')
          ;(r.readOnly = t.checked),
            (r.value = n.textContent),
            t.checked
              ? (r.classList.add('color-fg-subtle'),
                r.classList.add('color-bg-subtle'),
                r.classList.remove('color-bg-default'),
                r.classList.remove('color-fg-default'))
              : (r.classList.remove('color-fg-subtle'),
                r.classList.remove('color-bg-subtle'),
                r.classList.add('color-fg-default'),
                r.classList.add('color-bg-default'))
        }),
        (0, l.on)('click', '.js-privacy-toggle', function () {
          j = !0
        }),
        (0, l.on)('change', '.js-privacy-toggle', H),
        (0, l.on)('details-menu-selected', '.js-owner-container', L, { capture: !0 })
      let B = (e) => {
      ...
      ;(0, w.q6)('.js-owner-reponame .js-repo-name', function (e) {
        ...
        (0, l.on)('auto-check-complete', '.js-repo-name-auto-check', P),
        (0, w.q6)('.js-repo-url', function (e) {
          let t = e.target
          ...
          ;(n.hidden = !a.startsWith('http://')),
            (o.hidden = !a.startsWith('svn://')),
            (i.hidden = !a.startsWith('git://')),
            a.startsWith('svn://') || a.startsWith('git://')
              ? (t.classList.add('is-autocheck-errored'), r.classList.add('errored'))
              : (t.classList.remove('is-autocheck-errored'), r.classList.remove('errored')),
            P()
        }),
        (0, l.on)('change', '.js-repo-init-setting-menu-option', P),
        (0, l.on)('change', '.js-repo-readme', P),
        (0, l.on)('change', '.js-toggle-new-repo-default-branch-info', (e) => {
          let t = e.currentTarget
          N(t)
        }),
        F(null),
      ...
      async function Z(e) {
        let t
        let r = e.getAttribute('data-pulse-diffstat-summary-url')
        try {
          r && ((t = await X(r)), K(t, e))
        } catch (n) {
      ...
      ;(0, g.N7)('.js-pulse-contribution-data', (e) => {
        Z(e)
      })
      var z = r(48858)
      async function V(e) {
        ...
        return (
          G(e, 'saved'),
          setTimeout(G, 5e3, e, 'default'),
          (0, l.f)(t, 'release:saved', { release: o }),
          o
        )
      }
      function Y(e) {
      ...
      function G(e, t) {
        for (let r of e.querySelectorAll('.js-save-draft-button-state'))
          r.hidden = r.getAttribute('data-state') !== t
        e.disabled = 'saving' === t
      }
      function J(e) {
        ...
        if (null != t) {
          ...
          for (let t of document.querySelectorAll('.js-tag-status-message'))
      ...
      ;(0, l.on)('change', '.js-releases-marketplace-publish-field', function (e) {
        ...
        (0, g.N7)('.js-releases-marketplace-publish-field', function (e) {
          Y(e)
        }),
        (0, l.on)('click', '.js-save-draft', function (e) {
          let t = e.currentTarget
          t.disabled || (V(t), e.preventDefault())
        }),
      ...
      async function en(e) {
        ...
        if (t === et.get(e)) return
        J('loading'), et.set(e, t)
        ...
        let a = await i.json()
        'duplicate' === a.status &&
        parseInt(e.getAttribute('data-existing-id')) === parseInt(a.release_id)
          ? J('valid')
          : (document
              .querySelector('.js-release-tag .js-edit-release-link')
              .setAttribute('href', a.url),
            J(a.status)),
          eu(e)
      }
      async function eo(e) {
        let t = e.offsetWidth
        ;(e.style.width = `${t}px`), ea('loading'), e.setAttribute('aria-disabled', 'true')
        let r = e.getAttribute('data-repo-url'),
          n = `${r}/releases/notes`,
          o = new URL(n, window.location.origin),
          i = new URLSearchParams(o.search.slice(1))
        i.append('commitish', ec()),
          i.append('tag_name', er(document) || ''),
          i.append('previous_tag_name', ed()),
          (o.search = i.toString())
        let a = await fetch(o.toString(), { headers: { Accept: 'application/json' } })
        if (a.ok) {
          let e = await a.json()
          if (e.commitish === ec()) {
            let t = document.getElementById('release_body'),
              r = 'generated' === el() ? '' : t.value.trim()
            r ? (t.value = r.concat('\n\n', e.body)) : (t.value = e.body)
            let n = document.getElementById('release_name')
            n.value || (n.value = e.title),
              ea('succeed'),
              (0, p.x)('Successfully generated release notes'),
              es(r ? 'generated-and-edited' : 'generated'),
              ef(!0)
            let o = document.querySelector('.js-release-body-warning')
            ;(o.textContent = e.warning_message), (o.hidden = !e.warning_message)
          }
        } else {
          ea('failed'), e.setAttribute('aria-disabled', 'false')
          let t = await a.json()
          if (t && t.error) {
      ...
      ;(0, l.on)('click', '.js-generate-release-notes', function (e) {
        let t = e.currentTarget
        'true' !== t.getAttribute('aria-disabled') && eo(t)
      })
      let ei = ['pending', 'loading', 'succeed', 'failed']
      function ea(e) {
        if (
          (ei.map((t) => {
      ...
      function ec() {
        return 'valid' === Q()
          ? er(document) || ''
          : document.querySelector('input[name="release[target_commitish]"]:checked')?.value || ''
      }
      function ed() {
        return (
          document.querySelector('input[name="release[previous_tag_name]"]:checked')?.value || ''
        )
      }
      function eu(e) {
        let t = e.closest('form'),
        ...
        n ||
          ((n = String(r.getAttribute('data-preview-url'))),
          r.setAttribute('data-base-preview-url', n))
      ...
      function ef(e = !1) {
        let t = document.querySelector('.js-generate-release-notes'),
          ...
          i = 'valid' !== o && 'pending' !== o,
          a = e || i
        t.setAttribute('aria-disabled', a.toString()),
          n &&
            (a
              ? (n.textContent = `${
                  i ? 'Select a valid tag to a' : 'Clear existing notes to a'
      ...
      function ep(e) {
        if ('' === e.value) ef(), ea('pending'), es('initial')
        else {
          let e = el()
          ef('initial' !== e), 'generated' === e && es('generated-and-edited')
        }
      }
      ;(0, g.N7)('.js-release-tag', function (e) {
        en(e)
      }),
        (0, g.N7)('details-menu', function (e) {
          ;(0, z.e)(e)
        }),
        ...
        (0, g.N7)('#release_body', function (e) {
        ...
        (0, g.N7)('.js-release-form .js-previewable-comment-form', function (e) {
          let t = e.closest('form').querySelector('.js-release-tag')
          eu(t)
        }),
        (0, g.N7)('#release_page_title', function (e) {
          let t = e.textContent?.trim() || ''
          t.length && (document.title = t)
        }),
        (0, g.N7)('#release-filter', function (e) {
      ...
      function eh(e) {
        ...
        if (o && n) {
          let e = !1
          for (let n of ((r = o.getAttribute('data-shell-safe-name') || em).includes('<') &&
            (e = !0),
          t.querySelectorAll('.js-rename-branch-new-name')))
            n.textContent = r
          for (let n of ((r =
            o.getAttribute('data-shell-safe-name-with-remote') || `origin/${em}`).includes('<') &&
            (e = !0),
          t.querySelectorAll('.js-rename-branch-new-name-with-remote')))
            n.textContent = r
      ...
      let eg = (e) => {
          let t = document.querySelector(ey)
          if (t) {
            let r = 0 === e.value.length
            t.disabled = r
          }
        },
        ey = 'form.js-protected-branch-settings button[type="submit"]'
      ;(0, g.N7)(ey, {
        add() {
          let e = document.getElementById('rule_field')
          e && (eg(e), e.addEventListener('input', () => eg(e)))
        },
      }),
        (0, l.on)('change', '.js-template-repository-choice', function (e) {
          ...
          } else for (let e of a) e.textContent = ''
      ...
      ;(0, w.w4)('keydown', '.js-tree-finder-field', (e) => {
        'Escape' === e.key && (e.preventDefault(), history.back())
      }),
        (0, g.N7)('.js-tree-finder', (e) => {
          let t = e.querySelector('.js-tree-finder-field'),
            ...
            a = new eb.Z(t, o)
          ;(r.filter = (e, t) => '' === t || ((0, ev.CD)(t, e) && eS(t, e) > 0)),
            r.addEventListener('virtual-filter-input-filter', () => {
              n.updating = 'lazy'
            }),
            ...
            n.addEventListener('virtual-list-render-item', (e) => {
              ...
              let t = new ew.R(i, {
                  ...
                  urlEncodedItem: eq(e.detail.item),
                }),
                r = t.querySelector('marked-text')
              r && (r.positions = ev.m7), e.detail.fragment.append(t)
            }),
            (n.querySelector('ul').hidden = !1),
            t.focus(),
            a.start()
        })
      var eL = r(57260),
      ...
      async function eI(e) {
        ...
        try {
          await (0, s.DF)(e.getAttribute('data-poll-url')), (window.location.href = t)
        } catch (e) {
          ;(document.querySelector('.js-manifest-ready-check').hidden = !0),
            (document.querySelector('.js-manifest-ready-check-failed').hidden = !1)
        }
      }
      function eR(e) {
        let t = e.closest('form')
      ...
      ;(0, l.on)('file-attachment-accept', '.js-upload-manifest-file', function (e) {
        ...
        (0, l.on)('document:drop', '.js-upload-manifest-tree-view', async function (e) {
          let { transfer: t } = e.detail,
            r = e.currentTarget,
            n = await eL.P.traverse(t, !0),
            o = r.getAttribute('data-drop-url')
        ...
        (0, l.on)('upload:setup', '.js-upload-manifest-file', async function (e) {
          let { batch: t, form: r, preprocess: n } = e.detail,
            o = e.currentTarget
          function i() {
            r.append('upload_manifest_id', e_.get(o))
          }
          if ((ek(o, t), e_.get(o))) {
            i()
            return
          ...
          ;(p.value = u.upload_manifest.id), e_.set(o, u.upload_manifest.id), (eT = null), c()
        }),
        (0, l.on)('upload:start', '.js-upload-manifest-file', function (e) {
          let { attachment: t, batch: r } = e.detail,
            n = e.currentTarget.closest('.js-upload-manifest-file-container'),
            o = n.querySelector('.js-upload-progress'),
            i = o.querySelector('.js-upload-meter-text'),
            a = i.querySelector('.js-upload-meter-range-start')
        ...
        (0, l.on)('upload:complete', '.js-upload-manifest-file', function (e) {
          let { attachment: t, batch: r } = e.detail,
            ...
            o = n.querySelector('.js-manifest-file-entry').cloneNode(!0),
            i = o.querySelector('.js-filename')
          ...
          d.appendChild(o), r.isFinished() && eC(e.currentTarget)
        }),
        (0, l.on)('upload:progress', '.js-upload-manifest-file', function (e) {
          let { batch: t } = e.detail,
            r = e.currentTarget.closest('.js-upload-manifest-file-container'),
            n = r.querySelector('.js-upload-meter')
          n.style.width = `${t.percent()}%`
        }),
        (0, l.on)('upload:error', '.js-upload-manifest-file', eD),
        (0, l.on)('upload:invalid', '.js-upload-manifest-file', eD),
        (0, v.AC)('.js-remove-manifest-file-form', async function (e, t) {
          await t.html()
        ...
        (0, g.N7)('.js-manifest-ready-check', {
          initialize(e) {
            eI(e)
          },
        }),
      ...
      let eM = null
      function eO(e, t) {
        t.append('release_id', eR(e))
        let r = Array.from(
          document.querySelectorAll('.js-releases-field .js-release-file.delete .id')
        )
        if (r.length) {
      ...
      ;(0, l.on)('release:saved', '.js-release-form', function (e) {
        ...
        eM = null
        let r = !1
        for (let e of t.querySelectorAll('.js-releases-field .js-release-file'))
          e.classList.contains('delete')
            ? e.remove()
            : e.classList.contains('js-template') || (r = !0)
        ...
        (0, l.on)('upload:setup', '.js-upload-release-file', function (e) {
          let { form: t, preprocess: r } = e.detail,
            n = e.currentTarget
          if (eR(n)) {
            eO(n, t)
            return
        ...
        (0, l.on)('upload:start', '.js-upload-release-file', function (e) {
          ...
          if (n)
            for (let e of document.querySelectorAll('.js-releases-field .js-release-file .id'))
        ...
        (0, l.on)('upload:complete', '.js-upload-release-file', function (e) {
          let { attachment: t } = e.detail,
            r = document.querySelector('.js-releases-field'),
            n = r.querySelector('.js-template').cloneNode(!0)
          n.classList.remove('d-none', 'js-template'), (n.querySelector('input.id').value = t.id)
          let o = t.name || t.href.split('/').pop()
          for (let e of r.querySelectorAll('.js-release-file'))
            e.querySelector('.js-release-asset-filename')?.value === o &&
              'starter' === e.getAttribute('data-state') &&
              e.remove()
          for (let e of n.querySelectorAll('.js-release-asset-filename'))
            e instanceof HTMLInputElement ? (e.value = o) : (e.textContent = o)
          let i = `(${(t.file.size / 1048576).toFixed(2)} MB)`
          ;(n.querySelector('.js-release-asset-filesize').textContent = i),
            n.setAttribute('data-state', 'uploaded'),
            r.appendChild(n),
            r.classList.remove('not-populated'),
            r.classList.add('is-populated')
      ...
      let eN =
        (((n = class RepoCodespacesCountElement extends HTMLElement {
          connectedCallback() {
            ;(0, g.N7)('get-repo', {
              constructor: eH.b,
              add: (e) => {
          ...
          handleGetRepoElement(e) {
            e.openOrCreateInCodespace &&
              (0 === this.codespacesCount
                ? e.showOpenOrCreateInCodespace()
                : e.removeOpenOrCreateInCodespace())
          }
          constructor(...e) {
        ...
        n)
      eP([o.Lj], eN.prototype, 'codespacesCount', void 0), (eN = eP([o.Ih], eN))
      var e$ = r(55843),
        eB = r(82368),
        eU = r(58541),
        eF = r(4738)
    ...
    89359: (e, t, r) => {
      ...
      function o() {
        let e = n('meta[name=analytics-location]')
        return e ? e.content : window.location.pathname
      }
      function i() {
        let e = n('meta[name=analytics-location-query-strip]'),
          t = ''
        e || (t = window.location.search)
        let r = n('meta[name=analytics-location-params]')
        for (let e of (r && (t += (t ? '&' : '?') + r.content),
        document.querySelectorAll('meta[name=analytics-param-rename]'))) {
          let r = e.content.split(':', 2)
          t = t.replace(RegExp(`(^|[?&])${r[0]}($|=)`, 'g'), `$1${r[1]}$2`)
        }
        return t
      }
      function a() {
        return `${window.location.protocol}//${window.location.host}${o() + i()}`
      }
      r.d(t, { S: () => a })
    },
    24601: (e, t, r) => {
      r.d(t, { aJ: () => E, cI: () => S, eK: () => v })
      var n = r(82918),
        o = r(49237),
        i = r(28382),
        a = r(89359),
      ...
      let u = !1,
        f = 0,
        p = Date.now(),
        m = new Set(['Failed to fetch', 'NetworkError when attempting to fetch resource.'])
      function h(e) {
        return (
          e instanceof Error ||
          ('object' == typeof e &&
      ...
      function y(e) {
        return !!(
          'AbortError' === e.name ||
          ('TypeError' === e.name && m.has(e.message)) ||
          (e.name.startsWith('ApiError') && m.has(e.message))
        )
      }
      function v(e, t = {}) {
      ...
      async function b(e) {
        ...
        if (t) {
          if (L(e.error.stacktrace)) {
            u = !0
            return
          }
          f++
          try {
            await fetch(t, { method: 'post', body: JSON.stringify(e) })
          } catch {}
        }
      }
      function w(e) {
        return { type: e.name, value: e.message, stacktrace: S(e) }
      }
      function j(e, t = {}) {
      ...
      let q = /(chrome|moz|safari)-extension:\/\//
      function L(e) {
        return e.some((e) => q.test(e.filename) || q.test(e.function))
      }
      function E() {
      ...
      let A = !1
      function T() {
        return !A && !u && f < 10 && (0, o.Gb)()
      }
      if (
        (c.iG?.addEventListener('pageshow', () => (A = !1)),
        c.iG?.addEventListener('pagehide', () => (A = !0)),
    ...
    58700: (e, t, r) => {
      r.d(t, { Bt: () => i, DN: () => l, KL: () => u, Se: () => s, qC: () => f, sw: () => c })
      var n = r(5582)
      function o(e, t, r) {
        return e.dispatchEvent(new CustomEvent(t, { bubbles: !0, cancelable: r }))
      }
      function i(e, t) {
        t && (a(e, t), (0, n.j)(t)), o(e, 'submit', !0) && e.submit()
      }
      function a(e, t) {
      ...
      function l(e, t) {
        for (let r in t) {
          ...
          o instanceof HTMLInputElement
            ? (o.value = n)
            : o instanceof HTMLTextAreaElement && (o.value = n)
        }
      }
      function c(e) {
      ...
      function f(e) {
        return d(new FormData(e)).toString()
      }
    },
    5582: (e, t, r) => {
      function n(e) {
        ...
        if (e.name) {
          ...
          r ||
            ...
            r.classList.add('js-submit-button-value'),
            t.prepend(r)),
            (r.name = e.name),
            (r.value = o)
        } else r && r.remove()
    ...
    67044: (e, t, r) => {
      r.d(t, { EL: () => n.EL, N9: () => n.N9, Tz: () => n.Tz })
      var n = r(11793)
    },
    76134: (e, t, r) => {
      r.d(t, { Ty: () => o, YE: () => i, Zf: () => a })
      var n = r(67044)
      let o = () => {
        ...
        i = (e) =>
          /Enter|Arrow|Escape|Meta|Control|Esc/.test(e) ||
          (e.includes('Alt') && e.includes('Shift')),
        a = (e) => {
          let t = (0, n.EL)(e)
          return !!o() || i(t)
        }
    ...
    95253: (e, t, r) => {
      let n
      r.d(t, { YT: () => f, qP: () => p, yM: () => m })
      var o = r(88149),
        i = r(86058),
        a = r(44544),
        s = r(71643)
      let { getItem: l } = (0, a.Z)('localStorage'),
        c = 'dimension_',
        d = ['utm_source', 'utm_medium', 'utm_campaign', 'utm_term', 'utm_content', 'scid']
      try {
      ...
      function p(e, t = {}) {
        ...
        n && (u(o), n.sendEvent(e || 'unknown', u(o)))
      }
      function m(e) {
    ...
    75198: (e, t, r) => {
      r.d(t, { softNavigate: () => i })
      var n = r(67852),
        o = r(68202)
      function i(e, t) {
        ;(0, o.LD)('turbo'), (0, n.Vn)(e, { ...t })
      }
    },
    56959: (e, t, r) => {
      r.d(t, { RB: () => n, qC: () => o, w0: () => Subscription })
    ...
    7180: (e, t, r) => {
      r.d(t, { O: () => d, d: () => TrustedTypesPolicyError })
      var n = r(46426),
        o = r(71643),
        i = r(24601),
        a = r(27856),
      ...
      function c({
        ...
        try {
          ...
          ;(0, o.b)(
            { incrementKey: 'TRUSTED_TYPES_POLICY_CALLED', trustedTypesPolicyName: t },
            !1,
            0.1
          )
          let i = e()
          ...
          if (
            ...
            (d || (0, i.eK)(e),
            (0, o.b)({ incrementKey: 'TRUSTED_TYPES_POLICY_ERROR', trustedTypesPolicyName: t }),
            !a)
          )
            throw e
        }
    ...
    22490: (e, t, r) => {
      ...
      let a = {
        ...
        s = { createPolicy: (e, t) => ({ name: e, ...a, ...t }) },
        l = new Map(),
        c = globalThis.trustedTypes ?? s,
        d = {
          createPolicy: (e, t) => {
            if (l.has(e))
              return (0, o.b)({ incrementKey: 'TRUSTED_TYPES_POLICY_INITIALIZED_TWICE' }), l.get(e)
            {
              let r = c.createPolicy(e, t)
              return l.set(e, r), r
            }
          },
        },
  ...
  (e) => {
    ...
    e.O(
      ...
      [
        ...
        'vendors-node_modules_github_filter-input-element_dist_index_js-node_modules_github_mini-throt-08ab15',
        'vendors-node_modules_github_file-attachment-element_dist_index_js-node_modules_github_mini-th-55cf52',
...
//# sourceMappingURL=repositories-14d43c30e54c.js.map
