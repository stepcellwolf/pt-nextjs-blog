...
;(globalThis.webpackChunk = globalThis.webpackChunk || []).push([
  ['vendors-node_modules_github_selector-observer_dist_index_esm_js'],
  {
    36071: (e, t, r) => {
      ...
      function l(e, t) {
        i || (i = new MutationObserver(c)),
          o || ((o = e.createElement('div')), i.observe(o, { attributes: !0 })),
          s.push(t),
          o.setAttribute('data-twiddle', '' + Date.now())
      }
      function c() {
        var e = s
        s = []
      ...
      function v(e, t) {
        for (var r = 0; r < t.length; r++) {
          var n = t[r],
            ...
            i = n[1],
            s = n[2]
          o === x ? (p(s, i), m(s, i)) : o === A ? b(s, i) : o === O && g(e.observers, i)
        }
      }
      function p(e, t) {
      ...
      function w(e) {
        if (null === y) {
          ...
          t.appendChild(r), r.appendChild(n), (t.textContent = ''), (y = n.parentNode !== r)
        }
        return y
      }
      function S(e) {
      ...
      function k(e, t, r) {
        for (var n = 0; n < r.length; n++) {
          var o = r[n]
          'childList' === o.type
            ? (M(e, t, o.addedNodes), N(e, t, o.removedNodes))
            : 'attributes' === o.type && C(e, t, o.target)
        }
        w(e.ownerDocument) && D(e, t)
      }
      function M(e, t, r) {
        for (var n = 0; n < r.length; n++) {
          var o = r[n]
          ...
          if ('querySelectorAll' in o)
            for (var l = e.selectorSet.queryAll(o), c = 0; c < l.length; c++)
              for (var u = l[c], d = u.data, f = u.elements, h = 0; h < f.length; h++)
                t.push([x, f[h], d])
        }
      }
      function N(e, t, r) {
        for (var n = 0; n < r.length; n++) {
          ...
          if ('querySelectorAll' in o) {
            t.push([O, o])
            for (var i = o.querySelectorAll('*'), s = 0; s < i.length; s++) t.push([O, i[s]])
          }
        }
      }
      function C(e, t, r) {
        ...
        if ('querySelectorAll' in r) {
          ...
          if (s)
            for (var a = 0; a < s.length; a++) {
              ...
              l && !e.selectorSet.matchesSelector(r, l.selector) && t.push([A, r, l])
            }
        }
      }
      function _(e, t, r) {
        if ('querySelectorAll' in r) {
          C(e, t, r)
          for (var n = r.querySelectorAll('*'), o = 0; o < n.length; o++) C(e, t, n[o])
        }
      }
      function q(e, t, r) {
        for (var n = 0; n < r.length; n++)
          for (
            var o = r[n],
              i = o.form ? o.form.elements : e.rootNode.querySelectorAll('input'),
              s = 0;
            s < i.length;
            s++
          )
      ...
      function F(e, t) {
        ...
        'interactive' === r || 'complete' === r
          ? l(e, t)
          : e.addEventListener('DOMContentLoaded', l(e, t))
      }
      var z =
      ...
      function T(e) {
        ;(this.rootNode = 9 === e.nodeType ? e.documentElement : e),
          ...
          (this.observers = []),
          (this.selectorSet = new n.Z()),
          (this.mutationObserver = new MutationObserver(L.bind(this, this))),
          (this._scheduleAddRootNodes = a(this.ownerDocument, j.bind(this, this))),
          (this._handleThrottledChangedTargets = a(this.ownerDocument, R.bind(this, this))),
          this.rootNode.addEventListener('change', U.bind(this, this), !1),
          F(this.ownerDocument, I.bind(this, this))
      }
      function I(e) {
      ...
      ;(T.prototype.disconnect = function () {
        ...
        (T.prototype.observe = function (e, t) {
          var r = void 0
          'function' == typeof t
            ? (r = { selector: e, initialize: t })
            : (void 0 === t ? 'undefined' : z(t)) === 'object'
            ? ((r = t).selector = e)
            : (r = e)
          var n = this,
            o = {
              ...
              elements: [],
              elementConstructor: r.hasOwnProperty('constructor')
                ? r.constructor
        ...
        (T.prototype._abortObserving = function (e) {
          for (var t = e.elements, r = 0; r < t.length; r++) b(e, t[r])
          this.selectorSet.remove(e.selector, e), delete this.observers[e.id]
        }),
        (T.prototype.triggerObservers = function (e) {
          var t = []
          _(this, t, e), v(this, t)
        })
      var V = void 0
      function W() {
        return V || (V = new T(window.document)), V
      }
      function P() {
        var e
        return (e = W()).observe.apply(e, arguments)
      }
      var Z = null
    },
    8439: (e, t, r) => {
      ...
      function f(e, t) {
        var r, n, o
        for (r = 0, n = e.length; r < n; r++) if (((o = e[r]), t.isPrototypeOf(o))) return o
      }
      function h(e, t) {
        return e.id - t.id
      }
      ;(n.prototype.logDefaultIndexUsed = function () {}),
        (n.prototype.add = function (e, t) {
          ...
          if ('string' == typeof e) {
            for (
              n = 0, r = { id: this.uid++, selector: e, data: t }, c = d(this.indexes, e);
              n < c.length;
              n++
            )
              (s = (u = c[n]).key),
...
//# sourceMappingURL=vendors-node_modules_github_selector-observer_dist_index_esm_js-e156dfefd276.js.map
