...
export default function Photography() {
  const photos = [
    ...
    {
      original:
        'static/images/photography/predragtasevski-tour-de-france---st_malo-amour_15709656531_o.jpg',
    },
    {
      original:
        'static/images/photography/predragtasevski-tour-de-france---st_malo-chemin_15526358907_o.jpg',
    },
    {
      original:
        'static/images/photography/predragtasevski-tour-de-france---st_malo-la-nuit_15525695339_o.jpg',
    },
    {
      original:
        'static/images/photography/predragtasevski-tour-de-france---st_malo-seul_15711559345_o.jpg',
    },
    {
      original:
        'static/images/photography/predragtasevski-tour-de-france--bordeaux-miroir_15525693359_o.jpg',
    },
    {
      original:
        'static/images/photography/predragtasevski-tour-de-france--st-tropez-7_15091633224_o.jpg',
    },
    {
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="container py-12">
          <div className="-m-4 flex flex-wrap" id="static-thumbnails">
            <ImageGallery items={photos} autoPlay={true} showFullscreenButton={false} />
          </div>
        </div>
      </div>
    </>
